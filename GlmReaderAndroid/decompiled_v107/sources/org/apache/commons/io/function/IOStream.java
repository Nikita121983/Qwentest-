...
public interface IOStream<T> extends IOBaseStream<T, IOStream<T>, Stream<T>> {
    ...
    static <T> IOStream<T> iterate(final T seed, final IOUnaryOperator<T> f) {
        ...
        Iterator<T> iterator = new Iterator<T>() { // from class: org.apache.commons.io.function.IOStream.1
            ...
            public T next() throws NoSuchElementException {
                try {
                    T apply = this.t == IOStreams.NONE ? (T) seed : f.apply(this.t);
                    this.t = apply;
                    return apply;
                } catch (IOException e) {
    ...
    static /* synthetic */ DoubleStream lambda$flatMapToDouble$7(IOFunction mapper, Object t) {
    ...
    static /* synthetic */ IntStream lambda$flatMapToInt$8(IOFunction mapper, Object t) {
    ...
    static /* synthetic */ LongStream lambda$flatMapToLong$9(IOFunction mapper, Object t) {
    ...
    static /* synthetic */ IOException lambda$forAll$10(Integer i, IOException e) {
        return e;
    }

    default void forAll(IOConsumer<T> action) throws IOExceptionList {
        forAll(action, new BiFunction() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda5
    ...
    default void forAll(IOConsumer<T> action, final BiFunction<Integer, IOException, IOException> exSupplier) throws IOExceptionList {
        ...
        unwrap().forEach(new Consumer() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda18
            ...
            public final void accept(Object obj) {
                IOStream.lambda$forAll$11(IOConsumer.this, causeList, exSupplier, index, obj);
            }
        });
        IOExceptionList.checkEmpty(causeList.get(), null);
    }

    static /* synthetic */ void lambda$forAll$11(IOConsumer safeAction, AtomicReference causeList, BiFunction exSupplier, AtomicInteger index, Object e) {
        try {
            safeAction.accept(e);
    ...
    default T reduce(T identity, final IOBinaryOperator<T> accumulator) throws IOException {
        return unwrap().reduce(identity, new BinaryOperator() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda13
            @Override // java.util.function.BiFunction
            public final Object apply(Object obj, Object obj2) {
                Object apply;
                apply = Erase.apply(IOBinaryOperator.this, obj, obj2);
