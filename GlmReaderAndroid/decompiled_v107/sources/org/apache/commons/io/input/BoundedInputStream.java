...
public class BoundedInputStream extends ProxyInputStream {
    ...
    private BoundedInputStream(Builder builder) throws IOException {
        super(builder);
    ...
    private BoundedInputStream(InputStream inputStream, Builder builder) {
    ...
    public int available() throws IOException {
        int remaining = (int) Math.min(getRemaining(), 2147483647L);
    ...
    public long getRemaining() {
        ...
        return Math.max(0L, maxCount - getCount());
    }
    ...
    @Deprecated
    public synchronized void setPropagateClose(boolean propagateClose) {
        this.propagateClose = propagateClose;
    }
