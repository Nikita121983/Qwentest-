...
public class DumpArchiveSummary {
    ...
    public DumpArchiveSummary(byte[] buffer, ZipEncoding encoding) throws IOException {
        this.dumpDate = DumpArchiveUtil.convert32(buffer, 4) * 1000;
        this.previousDumpDate = DumpArchiveUtil.convert32(buffer, 8) * 1000;
    ...
    public boolean equals(Object obj) {
        ...
        if (Objects.equals(this.devname, other.devname) && this.dumpDate == other.dumpDate && Objects.equals(this.hostname, other.hostname)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return Objects.hash(this.devname, Long.valueOf(this.dumpDate), this.hostname);
    }
