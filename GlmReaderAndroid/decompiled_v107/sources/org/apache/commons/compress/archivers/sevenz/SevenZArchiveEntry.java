...
public class SevenZArchiveEntry implements ArchiveEntry {
    ...
    public void setContentMethods(Iterable<? extends SevenZMethodConfiguration> methods) {
        if (methods != null) {
            ...
            methods.forEach(new Consumer() { // from class: org.apache.commons.compress.archivers.sevenz.SevenZArchiveEntry$$ExternalSyntheticLambda0
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    l.addLast((SevenZMethodConfiguration) obj);
                }
            });
