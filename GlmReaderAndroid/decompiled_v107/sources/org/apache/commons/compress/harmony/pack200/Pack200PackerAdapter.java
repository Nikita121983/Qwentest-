...
public class Pack200PackerAdapter extends Pack200Adapter implements Pack200.Packer {
    ...
    public void firePropertyChange(String propertyName, Object oldValue, Object newValue) throws IOException {
        ...
        if (newValue != null && !newValue.equals(oldValue)) {
            ...
            if (propertyName.startsWith(Pack200.Packer.CODE_ATTRIBUTE_PFX)) {
            ...
            if (propertyName.equals(Pack200.Packer.DEFLATE_HINT)) {
                this.options.setDeflateHint((String) newValue);
                return;
            }
            if (propertyName.equals(Pack200.Packer.EFFORT)) {
                this.options.setEffort(ParsingUtils.parseIntValue((String) newValue));
                return;
            }
            if (propertyName.startsWith(Pack200.Packer.FIELD_ATTRIBUTE_PFX)) {
            ...
            if (propertyName.equals(Pack200.Packer.KEEP_FILE_ORDER)) {
                this.options.setKeepFileOrder(Boolean.parseBoolean((String) newValue));
                return;
            }
            if (propertyName.startsWith(Pack200.Packer.METHOD_ATTRIBUTE_PFX)) {
            ...
            if (propertyName.equals(Pack200.Packer.MODIFICATION_TIME)) {
                this.options.setModificationTime((String) newValue);
                return;
            }
            if (propertyName.startsWith(Pack200.Packer.PASS_FILE_PFX)) {
            ...
            if (propertyName.equals(Pack200.Packer.SEGMENT_LIMIT)) {
