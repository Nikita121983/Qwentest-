...
public class Messages {
    ...
    public static String format(String format, final Object[] args) {
        ...
        Arrays.setAll(argStrings, new IntFunction() { // from class: org.apache.commons.compress.harmony.archive.internal.nls.Messages$$ExternalSyntheticLambda1
            @Override // java.util.function.IntFunction
            public final Object apply(int i) {
                String objects;
                objects = Objects.toString(args[i], "<null>");
                return objects;
            }
        });
        int lastI = 0;
        ...
        try {
            return (ResourceBundle) AccessController.doPrivileged(new PrivilegedAction() { // from class: org.apache.commons.compress.harmony.archive.internal.nls.Messages$$ExternalSyntheticLambda0
                ...
                public final Object run() {
                    Object bundle2;
                    bundle2 = ResourceBundle.getBundle(resource, locale, loader != null ? loader : ClassLoader.getSystemClassLoader());
                    return bundle2;
                }
            });
        } catch (MissingResourceException e) {
