...
public class ByteCode extends ClassFileEntry {
    ...
    public void extractOperands(OperandManager operandManager, Segment segment, int codeLength) throws Pack200Exception {
    ...
    public void setOperand2Bytes(int operand, int position) {
        ...
        this.rewrite[firstOperandIndex + position] = (65280 & operand) >> 8;
