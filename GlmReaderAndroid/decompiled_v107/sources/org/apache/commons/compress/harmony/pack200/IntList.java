...
public class IntList {
    ...
    private void growForInsert(int location, int required) {
        ...
        System.arraycopy(this.array, this.firstIndex + location, newArray, newFirst + location + required, size - location);
    ...
    public int remove(int location) {
        ...
        if (location == size - 1) {
            ...
            int result2 = this.firstIndex;
            int elementIndex = result2 + location;
            int result3 = this.array[elementIndex];
            if (location < size / 2) {
        ...
        int result4 = this.firstIndex;
        if (result4 == this.lastIndex) {
            this.lastIndex = 0;
            this.firstIndex = 0;
        }
        this.modCount++;
