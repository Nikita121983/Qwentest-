...
public abstract class ByteCodeForm {
    ...
    public abstract void setByteCodeOperands(ByteCode byteCode, OperandManager operandManager, int i) throws Pack200Exception;
    ...
    static {
        ...
        byteCodeArray[194] = new NoArgumentForm(HSSFShapeTypes.ActionButtonBackPrevious, "monitorenter");
        byteCodeArray[195] = new NoArgumentForm(HSSFShapeTypes.ActionButtonEnd, "monitorexit");
        byteCodeArray[196] = new WideForm(HSSFShapeTypes.ActionButtonBeginning, "wide");
        byteCodeArray[197] = new MultiANewArrayForm(HSSFShapeTypes.ActionButtonReturn, "multianewarray", new int[]{HSSFShapeTypes.ActionButtonReturn, -1, -1, -1});
        byteCodeArray[198] = new LabelForm(HSSFShapeTypes.ActionButtonDocument, "ifnull", new int[]{HSSFShapeTypes.ActionButtonDocument, -1, -1});
        byteCodeArray[199] = new LabelForm(HSSFShapeTypes.ActionButtonSound, "ifnonnull", new int[]{HSSFShapeTypes.ActionButtonSound, -1, -1});
        byteCodeArray[200] = new LabelForm(200, "goto_w", new int[]{200, -1, -1, -1, -1}, true);
        byteCodeArray[201] = new LabelForm(HSSFShapeTypes.HostControl, "jsr_w", new int[]{HSSFShapeTypes.HostControl, -1, -1, -1, -1}, true);
        byteCodeArray[202] = new ThisFieldRefForm(HSSFShapeTypes.TextBox, "getstatic_this", new int[]{178, -1, -1});
        ...
        byteCodeArray[233] = new NarrowClassRefForm(UnknownRecord.BITMAP_00E9, "cldc", new int[]{18, -1});
        ...
        byteCodeArray[239] = new DoubleForm(UnknownRecord.PHONETICPR_00EF, "dldc2_w", new int[]{20, -1, -1});
