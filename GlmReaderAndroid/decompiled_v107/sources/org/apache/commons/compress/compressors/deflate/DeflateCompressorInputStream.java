...
public class DeflateCompressorInputStream extends CompressorInputStream implements InputStreamStatistics {
    ...
    public DeflateCompressorInputStream(InputStream inputStream, DeflateParameters parameters) {
        ...
        BoundedInputStream boundedInputStream = ((BoundedInputStream.Builder) BoundedInputStream.builder().setInputStream(inputStream)).asSupplier().get();
        this.countingStream = boundedInputStream;
        this.in = new InflaterInputStream(boundedInputStream, this.inflater);
    }
