...
public class SnappyCompressorOutputStream extends CompressorOutputStream<OutputStream> {
    ...
    public SnappyCompressorOutputStream(OutputStream out, long uncompressedSize, Parameters params) throws IOException {
        ...
        this.compressor = new LZ77Compressor(params, new LZ77Compressor.Callback() { // from class: org.apache.commons.compress.compressors.snappy.SnappyCompressorOutputStream$$ExternalSyntheticLambda0
            ...
            public final void accept(LZ77Compressor.Block block) {
                SnappyCompressorOutputStream.this.m2065xe163bd4f(block);
            }
        });
    ...
    public /* synthetic */ void m2065xe163bd4f(LZ77Compressor.Block block) throws IOException {
    ...
    private void writeBackReferenceWithOneOffsetByte(int len, int offset) throws IOException {
        this.out.write(((len - 4) << 2) | 1 | ((offset & 1792) >> 3));
