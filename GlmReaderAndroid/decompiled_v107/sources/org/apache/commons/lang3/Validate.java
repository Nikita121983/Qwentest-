...
public class Validate {
    ...
    public static <T extends Iterable<?>> T noNullElements(T iterable, final String message, final Object... values) {
        Objects.requireNonNull(iterable, "iterable");
        final AtomicInteger ai = new AtomicInteger();
        iterable.forEach(new Consumer() { // from class: org.apache.commons.lang3.Validate$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                Validate.lambda$noNullElements$0(message, values, ai, obj);
            }
        });
        return iterable;
    }
    ...
    public static /* synthetic */ void lambda$noNullElements$0(String message, Object[] values, AtomicInteger ai, Object e) {
        if (e == null) {
            throw new IllegalArgumentException(getMessage(message, ArrayUtils.addAll(values, Integer.valueOf(ai.getAndIncrement()))));
        }
    }
    ...
    private static Supplier<String> toSupplier(final String message, final Object... values) {
        return new Supplier() { // from class: org.apache.commons.lang3.Validate$$ExternalSyntheticLambda1
            ...
            public final Object get() {
                String message2;
                message2 = Validate.getMessage(message, values);
                return message2;
            }
        };
    }
