...
public class FieldUtils {
    ...
    public static Field getField(Class<?> cls, String fieldName, boolean forceAccess) {
        ...
        for (Class<?> class1 : ClassUtils.getAllInterfaces(cls)) {
            try {
                Field match2 = class1.getField(fieldName);
    ...
    public static List<Field> getFieldsListWithAnnotation(Class<?> cls, final Class<? extends Annotation> annotationCls) {
        ...
        return (List) getAllFieldsList(cls).stream().filter(new Predicate() { // from class: org.apache.commons.lang3.reflect.FieldUtils$$ExternalSyntheticLambda0
            ...
            public final boolean test(Object obj) {
                return FieldUtils.lambda$getFieldsListWithAnnotation$0(annotationCls, (Field) obj);
            }
        }).collect(Collectors.toList());
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ boolean lambda$getFieldsListWithAnnotation$0(Class annotationCls, Field field) {
        return field.getAnnotation(annotationCls) != null;
    }
    ...
    public static Object readDeclaredField(Object target, String fieldName, boolean forceAccess) throws IllegalAccessException {
        Objects.requireNonNull(target, TypedValues.AttributesType.S_TARGET);
