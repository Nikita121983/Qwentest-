...
public final class SystemProperties {
    ...
    public static int getInt(String key, IntSupplier defaultIfAbsent) {
        ...
        if (defaultIfAbsent != null) {
            return defaultIfAbsent.getAsInt();
        }
        return 0;
    }
    ...
    public static long getLong(String key, LongSupplier defaultIfAbsent) {
        ...
        if (defaultIfAbsent != null) {
            return defaultIfAbsent.getAsLong();
        }
        return 0L;
    }
    ...
    public static String getProperty(String property) {
        return getProperty(property, (Supplier<String>) Suppliers.nul());
    }

    static String getProperty(String property, final String defaultIfAbsent) {
        return getProperty(property, (Supplier<String>) new Supplier() { // from class: org.apache.commons.lang3.SystemProperties$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return SystemProperties.lambda$getProperty$0(defaultIfAbsent);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ String lambda$getProperty$0(String defaultIfAbsent) {
        return defaultIfAbsent;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static String getProperty(String property, Supplier<String> defaultIfAbsent) {
        try {
            if (StringUtils.isEmpty(property)) {
                return (String) Suppliers.get(defaultIfAbsent);
            }
            return (String) StringUtils.getIfEmpty(System.getProperty(property), defaultIfAbsent);
