...
public class PredicatedMap<K, V> extends AbstractInputCheckedMapDecorator<K, V> implements Serializable {
    ...
    public PredicatedMap(Map<K, V> map, Predicate<? super K> keyPredicate, Predicate<? super V> valuePredicate) {
        super(map);
        this.keyPredicate = keyPredicate;
        this.valuePredicate = valuePredicate;
        map.forEach(new BiConsumer() { // from class: org.apache.commons.collections4.map.PredicatedMap$$ExternalSyntheticLambda0
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
                PredicatedMap.this.validate(obj, obj2);
            }
        });
    }
    ...
    protected V checkSetValue(V value) {
        if (!this.valuePredicate.test(value)) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void validate(K key, V value) {
        if (this.keyPredicate != null && !this.keyPredicate.test(key)) {
            throw new IllegalArgumentException("Cannot add key - Predicate rejected it");
        }
        if (this.valuePredicate != null && !this.valuePredicate.test(value)) {
