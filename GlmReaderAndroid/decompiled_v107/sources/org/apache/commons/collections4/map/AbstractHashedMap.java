...
public class AbstractHashedMap<K, V> extends AbstractMap<K, V> implements IterableMap<K, V> {
    ...
    public static class EntrySet<K, V> extends AbstractSet<Map.Entry<K, V>> {
        ...
        /* JADX INFO: Access modifiers changed from: protected */
        public EntrySet(AbstractHashedMap<K, V> parent) {
            this.parent = parent;
        }
    ...
    public static class HashEntry<K, V> implements Map.Entry<K, V>, KeyValue<K, V> {
        ...
        /* JADX INFO: Access modifiers changed from: protected */
        public HashEntry(HashEntry<K, V> next, int hashCode, Object key, V value) {
            this.next = next;
    ...
    public static abstract class HashIterator<K, V> {
        ...
        public String toString() {
            if (this.last != null) {
                return "Iterator[" + this.last.getKey() + "=" + this.last.getValue() + CollectionUtils.DEFAULT_TOSTRING_SUFFIX;
            }
            return "Iterator[]";
        }
    }
    ...
    public static class KeySet<K> extends AbstractSet<K> {
        ...
        /* JADX INFO: Access modifiers changed from: protected */
        public KeySet(AbstractHashedMap<K, ?> parent) {
            this.parent = parent;
        }
    ...
    public static class Values<V> extends AbstractCollection<V> {
        ...
        /* JADX INFO: Access modifiers changed from: protected */
        public Values(AbstractHashedMap<?, V> parent) {
            this.parent = parent;
        }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public AbstractHashedMap(int initialCapacity) {
        this(initialCapacity, 0.75f);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public AbstractHashedMap(int initialCapacity, float loadFactor) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public AbstractHashedMap(int initialCapacity, float loadFactor, int threshold) {
        this.loadFactor = loadFactor;
    ...
    public boolean containsKey(Object key) {
        ...
        for (HashEntry<K, V> entry = this.data[hashIndex(hashCode, this.data.length)]; entry != null; entry = entry.next) {
    ...
    public String toString() {
        ...
        while (hasNext) {
            ...
            hasNext = it.hasNext();
            if (hasNext) {
                buf.append(CollectionUtils.COMMA).append(Chars.SPACE);
            }
        }
        buf.append('}');
        return buf.toString();
