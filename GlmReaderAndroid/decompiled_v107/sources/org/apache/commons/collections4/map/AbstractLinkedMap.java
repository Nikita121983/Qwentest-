...
public abstract class AbstractLinkedMap<K, V> extends AbstractHashedMap<K, V> implements OrderedMap<K, V> {
    ...
    public static abstract class LinkIterator<K, V> {
        ...
        protected LinkIterator(AbstractLinkedMap<K, V> parent) {
            this.parent = (AbstractLinkedMap) Objects.requireNonNull(parent);
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public AbstractLinkedMap(int initialCapacity, float loadFactor, int threshold) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // org.apache.commons.collections4.map.AbstractHashedMap
    public void addEntry(AbstractHashedMap.HashEntry<K, V> entry, int hashIndex) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public LinkEntry<K, V> getEntry(int index) {
        LinkEntry<K, V> entry;
        if (index < 0) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // org.apache.commons.collections4.map.AbstractHashedMap
    public void removeEntry(AbstractHashedMap.HashEntry<K, V> entry, int hashIndex, AbstractHashedMap.HashEntry<K, V> previous) {
        LinkEntry<K, V> link = (LinkEntry) entry;
