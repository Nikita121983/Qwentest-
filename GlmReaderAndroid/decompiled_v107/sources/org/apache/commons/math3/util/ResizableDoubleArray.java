...
public class ResizableDoubleArray implements DoubleArray, Serializable {
    ...
    public ResizableDoubleArray(int initialCapacity, double expansionFactor) throws MathIllegalArgumentException {
        this(initialCapacity, expansionFactor, expansionFactor + DEFAULT_CONTRACTION_DELTA);
    }
    ...
    public boolean equals(Object object) {
        ...
        synchronized (this) {
            synchronized (object) {
                ...
                boolean result2 = 1 != 0 && other.contractionCriterion == this.contractionCriterion;
                ...
                if (!result5 || other.startIndex != this.startIndex) {
                    result = false;
                }
                if (result) {
    ...
    public synchronized int hashCode() {
        int[] hashData;
        hashData = new int[]{Double.valueOf(this.expansionFactor).hashCode(), Double.valueOf(this.contractionCriterion).hashCode(), this.expansionMode.hashCode(), Arrays.hashCode(this.internalArray), this.numElements, this.startIndex};
