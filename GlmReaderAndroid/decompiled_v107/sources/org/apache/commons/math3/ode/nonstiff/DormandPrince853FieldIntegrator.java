...
public class DormandPrince853FieldIntegrator<T extends RealFieldElement<T>> extends EmbeddedRungeKuttaFieldIntegrator<T> {
    ...
    public T[] getC() {
        ...
        tArr[7] = fraction(127, HSSFShapeTypes.ActionButtonEnd);
        tArr[8] = fraction(3, 5);
        tArr[9] = fraction(6, 7);
    ...
    public T[][] getA() {
        ...
        tArr[3][2] = (RealFieldElement) ((RealFieldElement) ((RealFieldElement) realFieldElement.multiply(HSSFShapeTypes.ActionButtonReturn)).add(402.0d)).divide(-1000.0d);
        ...
        tArr[10][8] = fraction(-2.8388795297996248E16d, 3.199510091356783E15d);
    ...
    protected T estimateError(T[][] yDotK, T[] y0, T[] y1, T h) {
        ...
        for (int j = 0; j < this.mainSetDimension; j++) {
            RealFieldElement realFieldElement3 = (RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) yDotK[0][j].multiply(this.e1_01)).add((RealFieldElement) yDotK[5][j].multiply(this.e1_06))).add((RealFieldElement) yDotK[6][j].multiply(this.e1_07))).add((RealFieldElement) yDotK[7][j].multiply(this.e1_08))).add((RealFieldElement) yDotK[8][j].multiply(this.e1_09))).add((RealFieldElement) yDotK[9][j].multiply(this.e1_10))).add((RealFieldElement) yDotK[10][j].multiply(this.e1_11))).add((RealFieldElement) yDotK[11][j].multiply(this.e1_12));
            RealFieldElement realFieldElement4 = (RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) yDotK[0][j].multiply(this.e2_01)).add((RealFieldElement) yDotK[5][j].multiply(this.e2_06))).add((RealFieldElement) yDotK[6][j].multiply(this.e2_07))).add((RealFieldElement) yDotK[7][j].multiply(this.e2_08))).add((RealFieldElement) yDotK[8][j].multiply(this.e2_09))).add((RealFieldElement) yDotK[9][j].multiply(this.e2_10))).add((RealFieldElement) yDotK[10][j].multiply(this.e2_11))).add((RealFieldElement) yDotK[11][j].multiply(this.e2_12));
        ...
        return (T) ((RealFieldElement) ((RealFieldElement) h.abs()).multiply(realFieldElement)).divide((RealFieldElement) ((RealFieldElement) realFieldElement8.multiply(this.mainSetDimension)).sqrt());
    }
}
