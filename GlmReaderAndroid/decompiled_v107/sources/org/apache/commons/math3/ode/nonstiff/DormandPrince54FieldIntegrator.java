...
public class DormandPrince54FieldIntegrator<T extends RealFieldElement<T>> extends EmbeddedRungeKuttaFieldIntegrator<T> {
    ...
    protected T estimateError(T[][] yDotK, T[] y0, T[] y1, T h) {
        ...
        for (int j = 0; j < this.mainSetDimension; j++) {
            RealFieldElement realFieldElement = (RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) ((RealFieldElement) yDotK[0][j].multiply(this.e1)).add((RealFieldElement) yDotK[2][j].multiply(this.e3))).add((RealFieldElement) yDotK[3][j].multiply(this.e4))).add((RealFieldElement) yDotK[4][j].multiply(this.e5))).add((RealFieldElement) yDotK[5][j].multiply(this.e6))).add((RealFieldElement) yDotK[6][j].multiply(this.e7));
