...
class DormandPrince54FieldStepInterpolator<T extends RealFieldElement<T>> extends RungeKuttaFieldStepInterpolator<T> {
    ...
    protected FieldODEStateAndDerivative<T> computeInterpolatedStateAndDerivatives(FieldEquationsMapper<T> mapper, T time, T theta, T thetaH, T oneMinusThetaH) {
        ...
        if (getGlobalPreviousState() != null && theta.getReal() <= 0.5d) {
            ...
            T t = this.a70;
            T coeff5 = this.a70;
            RealFieldElement realFieldElement17 = (RealFieldElement) ((RealFieldElement) ((RealFieldElement) t.subtract(realFieldElement4.multiply((RealFieldElement) coeff5.subtract(1.0d)))).add((RealFieldElement) realFieldElement5.multiply((RealFieldElement) ((RealFieldElement) this.a70.multiply(2)).subtract(1.0d)))).add((RealFieldElement) realFieldElement6.multiply(this.d0));
            ...
            RealFieldElement[] previousStateLinearCombination = previousStateLinearCombination(realFieldElement10, realFieldElement11, realFieldElement12, realFieldElement13, realFieldElement14, realFieldElement15, realFieldElement16);
            derivativeLinearCombination = derivativeLinearCombination(realFieldElement17, realFieldElement18, realFieldElement19, realFieldElement20, realFieldElement21, realFieldElement22, realFieldElement23);
            currentStateLinearCombination = previousStateLinearCombination;
        } else {
            ...
            T t2 = this.a70;
            T coeff52 = this.a70;
            RealFieldElement realFieldElement35 = (RealFieldElement) ((RealFieldElement) ((RealFieldElement) t2.subtract(realFieldElement4.multiply((RealFieldElement) coeff52.subtract(1.0d)))).add((RealFieldElement) realFieldElement5.multiply((RealFieldElement) ((RealFieldElement) this.a70.multiply(2)).subtract(1.0d)))).add((RealFieldElement) realFieldElement6.multiply(this.d0));
            ...
            currentStateLinearCombination = currentStateLinearCombination(realFieldElement28, realFieldElement29, realFieldElement30, realFieldElement31, realFieldElement32, realFieldElement33, realFieldElement34);
