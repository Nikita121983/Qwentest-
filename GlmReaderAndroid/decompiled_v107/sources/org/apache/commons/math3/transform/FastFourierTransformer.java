...
public class FastFourierTransformer implements Serializable {
    ...
    private static void normalizeTransformedData(double[][] dataRI, DftNormalization normalization, TransformType type) {
        ...
        switch (normalization) {
            case STANDARD:
                ...
                return;
            case UNITARY:
                double scaleFactor2 = 1.0d / FastMath.sqrt(n);
    ...
    public static class MultiDimensionalComplexMatrix implements Cloneable {
        ...
        MultiDimensionalComplexMatrix(Object multiDimensionalComplexArray) {
            ...
            for (Object lastDimension = multiDimensionalComplexArray; lastDimension instanceof Object[]; lastDimension = ((Object[]) lastDimension)[0]) {
                numOfDimensions++;
            }
        ...
        private void clone(MultiDimensionalComplexMatrix mdcm) {
            ...
            int[][] vectorList = (int[][]) Array.newInstance((Class<?>) Integer.TYPE, size, this.dimensionSize.length);
