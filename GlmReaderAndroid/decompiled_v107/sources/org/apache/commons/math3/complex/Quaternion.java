...
public final class Quaternion implements Serializable {
    ...
    public String toString() {
        ...
        s.append(CollectionUtils.DEFAULT_TOSTRING_PREFIX).append(this.q0).append(StringUtils.SPACE).append(this.q1).append(StringUtils.SPACE).append(this.q2).append(StringUtils.SPACE).append(this.q3).append(CollectionUtils.DEFAULT_TOSTRING_SUFFIX);
        return s.toString();
    }
}
