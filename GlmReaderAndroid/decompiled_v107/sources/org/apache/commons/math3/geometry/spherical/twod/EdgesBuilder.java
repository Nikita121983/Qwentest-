...
public class EdgesBuilder implements BSPTreeVisitor<Sphere2D> {
    ...
    /* JADX WARN: Type inference failed for: r3v3, types: [org.apache.commons.math3.geometry.spherical.twod.S2Point] */
    /* JADX WARN: Type inference failed for: r3v5, types: [org.apache.commons.math3.geometry.spherical.twod.S2Point] */
    private void addContribution(SubCircle sub, boolean reversed, BSPTree<Sphere2D> node) {
        ...
        for (Arc a : arcs) {
            Vertex start = new Vertex(circle.toSpace((Point<Sphere1D>) new S1Point(a.getInf())));
            Vertex end = new Vertex(circle.toSpace((Point<Sphere1D>) new S1Point(a.getSup())));
