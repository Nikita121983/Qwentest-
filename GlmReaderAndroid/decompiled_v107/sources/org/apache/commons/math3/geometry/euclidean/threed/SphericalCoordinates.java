...
public class SphericalCoordinates implements Serializable {
    ...
    public double[][] toCartesianHessian(double[][] sHessian, double[] sGradient) {
        computeJacobian();
        computeHessians();
        double[][] hj = (double[][]) Array.newInstance((Class<?>) Double.TYPE, 3, 3);
        double[][] cHessian = (double[][]) Array.newInstance((Class<?>) Double.TYPE, 3, 3);
    ...
    private void computeJacobian() {
        if (this.jacobian == null) {
            ...
            double r2 = (z * z) + rho2;
            this.jacobian = (double[][]) Array.newInstance((Class<?>) Double.TYPE, 3, 3);
    ...
    private void computeHessians() {
        if (this.rHessian == null) {
            ...
            double yOr3 = yOr / r2;
            double zOr3 = zOr / r2;
            this.rHessian = (double[][]) Array.newInstance((Class<?>) Double.TYPE, 3, 3);
            ...
            this.thetaHessian = (double[][]) Array.newInstance((Class<?>) Double.TYPE, 2, 2);
            ...
            this.phiHessian = (double[][]) Array.newInstance((Class<?>) Double.TYPE, 3, 3);
            ...
            this.phiHessian[2][2] = ((rho * 2.0d) * zOr3) / this.r;
