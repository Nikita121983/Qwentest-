...
public class ConvexHull2D implements ConvexHull<Euclidean2D, Vector2D>, Serializable {
    ...
    /* JADX WARN: Type inference failed for: r8v0, types: [org.apache.commons.math3.geometry.euclidean.twod.Vector2D] */
    /* JADX WARN: Type inference failed for: r9v0, types: [org.apache.commons.math3.geometry.euclidean.twod.Vector2D] */
    private boolean isConvex(Vector2D[] hullVertices) {
        ...
        while (i < hullVertices.length) {
            ...
            ?? subtract = p2.subtract((Vector<Euclidean2D>) p1);
            ?? subtract2 = p3.subtract((Vector<Euclidean2D>) p2);
            double crossProduct = MathArrays.linearCombination(subtract.getX(), subtract2.getY(), -subtract.getY(), subtract2.getX());
