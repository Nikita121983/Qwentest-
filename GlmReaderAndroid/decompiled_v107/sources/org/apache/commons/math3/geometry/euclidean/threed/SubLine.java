...
public class SubLine {
    ...
    /* JADX WARN: Type inference failed for: r5v2, types: [org.apache.commons.math3.geometry.euclidean.threed.Vector3D] */
    ...
    public Vector3D intersection(SubLine subLine, boolean includeEndPoints) {
        ...
        Region.Location loc1 = this.remainingRegion.checkPoint(this.line.toSubSpace((Point<Euclidean3D>) v1D));
        Region.Location loc2 = subLine.remainingRegion.checkPoint(subLine.line.toSubSpace((Point<Euclidean3D>) v1D));
        if (includeEndPoints) {
