...
public class BinomialDistribution extends AbstractIntegerDistribution {
    ...
    public double logProbability(int x) {
        ...
        if (x >= 0 && x <= this.numberOfTrials) {
            double ret = SaddlePointExpansion.logBinomialProbability(x, this.numberOfTrials, this.probabilityOfSuccess, 1.0d - this.probabilityOfSuccess);
            return ret;
        }
    ...
    public double cumulativeProbability(int x) {
        ...
        double ret = 1.0d - Beta.regularizedBeta(this.probabilityOfSuccess, x + 1.0d, this.numberOfTrials - x);
        return ret;
    }
    ...
    public double getNumericalVariance() {
        ...
        return this.numberOfTrials * p * (1.0d - p);
    }
