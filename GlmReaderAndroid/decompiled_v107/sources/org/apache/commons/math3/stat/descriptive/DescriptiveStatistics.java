...
public class DescriptiveStatistics implements StatisticalSummary, Serializable {
    ...
    public String toString() {
        ...
        outBuffer.append("DescriptiveStatistics:").append(StringUtils.LF);
        ...
        try {
            outBuffer.append("median: ").append(getPercentile(50.0d)).append(StringUtils.LF);
        } catch (MathIllegalStateException e) {
            outBuffer.append("median: unavailable").append(StringUtils.LF);
        }
        outBuffer.append("skewness: ").append(getSkewness()).append(StringUtils.LF);
        outBuffer.append("kurtosis: ").append(getKurtosis()).append(StringUtils.LF);
