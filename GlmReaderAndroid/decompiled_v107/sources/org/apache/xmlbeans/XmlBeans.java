...
public final class XmlBeans {
    ...
    static {
        ...
        XMLBEANS_VERSION = EnvironmentCompat.MEDIA_UNKNOWN;
    ...
    public static QNameCache getQNameCache() {
        ...
        if (qnameCache == null) {
            ...
            _threadLocalLoaderQNameCache.set(new SoftReference(qnameCache2));
            return qnameCache2;
        }
        return qnameCache;
    }
    ...
    public static SchemaTypeSystem typeSystemForClassLoader(ClassLoader loader, String stsName) {
        ...
        if (loader != null) {
            ...
            try {
                ...
                throw causedException(new RuntimeException("Cannot load SchemaTypeSystem. Unable to load class with name " + stsName + "." + HOLDER_CLASS_NAME + ". Make sure the generated binary files are on the classpath."), e);
            } catch (IllegalAccessException e2) {
                throw causedException(new RuntimeException("Field typeSystem on class " + stsName + "." + HOLDER_CLASS_NAME + "is not accessible. Please verify the version of xmlbeans.jar is correct."), e2);
            } catch (NoSuchFieldException e3) {
                throw causedException(new RuntimeException("Cannot find field typeSystem on class " + stsName + "." + HOLDER_CLASS_NAME + ". Please verify the version of xmlbeans.jar is correct."), e3);
            }
        }
        ...
        SchemaTypeSystem schemaTypeSystem = sts;
        if (sts == null) {
    ...
    public static SchemaType typeForClass(Class c) {
        ...
        try {
            Field typeField = c.getField(ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY);
            if (typeField == null) {
                return null;
            }
