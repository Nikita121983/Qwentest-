...
public abstract class JavaGDateHolderEx extends XmlObjectBase {
    ...
    public static GDate validateLexical(String v, SchemaType sType, ValidationContext context) {
        ...
        if (date != null && sType.hasPatternFacet() && !sType.matchPatternFacet(v)) {
            context.invalid(XmlErrorCodes.DATATYPE_VALID$PATTERN_VALID, new Object[]{XmlErrorCodes.DATE, v, QNameHelper.readable(sType)});
        }
        return date;
    }
    ...
    public static void validateValue(GDateSpecification v, SchemaType sType, ValidationContext context) {
        ...
        if (x != null) {
            GDate g = ((XmlObjectBase) x).getGDateValue();
            if (v.compareToGDate(g) <= 0) {
                context.invalid(XmlErrorCodes.DATATYPE_MIN_EXCLUSIVE_VALID, new Object[]{XmlErrorCodes.DATE, v, g, QNameHelper.readable(sType)});
            }
        }
        XmlObject x2 = sType.getFacet(4);
        if (x2 != null) {
            GDate g2 = ((XmlObjectBase) x2).getGDateValue();
            if (v.compareToGDate(g2) < 0) {
                context.invalid(XmlErrorCodes.DATATYPE_MIN_INCLUSIVE_VALID, new Object[]{XmlErrorCodes.DATE, v, g2, QNameHelper.readable(sType)});
            }
        }
        XmlObject x3 = sType.getFacet(6);
        if (x3 != null) {
            GDate g3 = ((XmlObjectBase) x3).getGDateValue();
            if (v.compareToGDate(g3) >= 0) {
                context.invalid(XmlErrorCodes.DATATYPE_MAX_EXCLUSIVE_VALID, new Object[]{XmlErrorCodes.DATE, v, g3, QNameHelper.readable(sType)});
            }
        }
        XmlObject x4 = sType.getFacet(5);
        if (x4 != null) {
            GDate g4 = ((XmlObjectBase) x4).getGDateValue();
            if (v.compareToGDate(g4) > 0) {
                context.invalid(XmlErrorCodes.DATATYPE_MAX_INCLUSIVE_VALID, new Object[]{XmlErrorCodes.DATE, v, g4, QNameHelper.readable(sType)});
            }
        }
        ...
        if (vals != null) {
            ...
            context.invalid(XmlErrorCodes.DATATYPE_ENUM_VALID, new Object[]{XmlErrorCodes.DATE, v, QNameHelper.readable(sType)});
        }
    }
