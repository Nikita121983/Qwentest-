...
public class JavaUriHolderEx extends JavaUriHolder {
    ...
    public static void validateLexical(String v, SchemaType sType, ValidationContext context) {
        ...
        if (x != null && (i3 = ((SimpleValue) x).getBigIntegerValue().intValue()) != v.length()) {
            context.invalid(XmlErrorCodes.DATATYPE_LENGTH_VALID$STRING, new Object[]{XmlErrorCodes.ANYURI, v, Integer.valueOf(i3), QNameHelper.readable(sType)});
        }
        XmlObject x2 = sType.getFacet(1);
        if (x2 != null && (i2 = ((SimpleValue) x2).getBigIntegerValue().intValue()) > v.length()) {
            context.invalid(XmlErrorCodes.DATATYPE_MIN_LENGTH_VALID$STRING, new Object[]{XmlErrorCodes.ANYURI, v, Integer.valueOf(i2), QNameHelper.readable(sType)});
        }
        XmlObject x3 = sType.getFacet(2);
        if (x3 != null && (i = ((SimpleValue) x3).getBigIntegerValue().intValue()) < v.length()) {
            context.invalid(XmlErrorCodes.DATATYPE_MAX_LENGTH_VALID$STRING, new Object[]{XmlErrorCodes.ANYURI, v, Integer.valueOf(i), QNameHelper.readable(sType)});
        }
    }
