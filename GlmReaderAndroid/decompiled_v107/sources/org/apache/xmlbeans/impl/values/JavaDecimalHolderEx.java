    ...
    public static void validateValue(BigDecimal v, SchemaType sType, ValidationContext context) {
        ...
        if (fd != null) {
            ...
            try {
                ...
                context.invalid(XmlErrorCodes.DATATYPE_FRACTION_DIGITS_VALID, new Object[]{Integer.valueOf(v.scale()), v.toString(), Integer.valueOf(scale), QNameHelper.readable(sType)});
                return;
            }
        }
        ...
        if (td != null) {
            ...
            if (len > tdf) {
                context.invalid(XmlErrorCodes.DATATYPE_TOTAL_DIGITS_VALID, new Object[]{Integer.valueOf(len), v.toString(), Integer.valueOf(tdf), QNameHelper.readable(sType)});
                return;
            }
        }
