...
public class KeyrefDocumentImpl extends XmlComplexContentImpl implements KeyrefDocument {
    ...
    public KeyrefDocument.Keyref getKeyref() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            KeyrefDocument.Keyref target = (KeyrefDocument.Keyref) get_store().find_element_user(PROPERTY_QNAME[0], 0);
            keyref = target == null ? null : target;
        }
        return keyref;
    }
    ...
    public KeyrefDocument.Keyref addNewKeyref() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            target = (KeyrefDocument.Keyref) get_store().add_element_user(PROPERTY_QNAME[0]);
        }
        return target;
    }
