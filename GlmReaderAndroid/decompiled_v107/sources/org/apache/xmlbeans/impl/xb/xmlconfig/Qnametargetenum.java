...
public interface Qnametargetenum extends XmlToken {
    ...
    public static final Enum TYPE = Enum.forString(ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY);
    ...
    public static final class Enum extends StringEnumAbstractBase {
        ...
        public static final StringEnumAbstractBase.Table table = new StringEnumAbstractBase.Table(new Enum[]{new Enum(ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY, 1), new Enum("document-type", 2), new Enum("accessor-element", 3), new Enum("accessor-attribute", 4)});
