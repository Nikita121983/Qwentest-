...
public class SoapEncSchemaTypeSystem extends SchemaTypeLoaderBase implements SchemaTypeSystem {
    ...
    private SoapEncSchemaTypeSystem() {
        SchemaContainer _container = new SchemaContainer("http://schemas.xmlsoap.org/soap/encoding/");
        ...
        this.soapArrayHandle = SOAP_ARRAY.toLowerCase(Locale.ROOT) + ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY;
        ...
        attr4.init(new QName("http://schemas.xmlsoap.org/soap/encoding/", "offset"), BuiltinSchemaTypeSystem.ST_STRING.getRef(), 2, null, null, null, false, null, null, null);
