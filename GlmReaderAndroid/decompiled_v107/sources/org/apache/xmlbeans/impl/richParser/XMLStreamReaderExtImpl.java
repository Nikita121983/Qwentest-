    ...
    private static class CharSeqTrimWS implements CharSequence {
        ...
        void reload(int style) throws XMLStreamException {
            ...
            if (style == 1) {
                ...
                while (true) {
                    this._nonWSEnd = i2;
                    if (this._nonWSEnd <= this._nonWSStart || !XMLChar.isSpace(this._buf[this._nonWSEnd - 1])) {
                        break;
                    } else {
                        i2 = this._nonWSEnd - 1;
                    }
                ...
                if (length() == 0 && this._xmlSteam._defaultValue != null) {
                    ...
                    while (true) {
                        this._nonWSStart = i;
                        if (this._nonWSStart >= this._length || !XMLChar.isSpace(this._buf[this._nonWSStart])) {
                            break;
                        } else {
                            i = this._nonWSStart + 1;
                        }
                    }
                    int i3 = this._length;
                    while (true) {
        ...
        CharSequence reloadAtt(String uri, String local, int style) throws XMLStreamException {
            ...
            if (style == 2) {
                ...
                while (true) {
                    this._nonWSStart = i;
                    if (this._nonWSStart >= length || !XMLChar.isSpace(value.charAt(this._nonWSStart))) {
                        break;
                    }
                    i = this._nonWSStart + 1;
                }
        ...
        public char charAt(int index) {
            if (index >= this._nonWSEnd - this._nonWSStart || -1 >= index) {
