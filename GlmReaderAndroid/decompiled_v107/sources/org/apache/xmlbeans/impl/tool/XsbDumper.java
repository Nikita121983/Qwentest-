...
public class XsbDumper {
    ...
    private static void dump(File file, boolean force) {
        if (file.isDirectory()) {
            File[] files = file.listFiles(new FileFilter() { // from class: org.apache.xmlbeans.impl.tool.XsbDumper$$ExternalSyntheticLambda0
                @Override // java.io.FileFilter
                public final boolean accept(File file2) {
                    return XsbDumper.lambda$dump$0(file2);
                }
            });
            if (files != null) {
        ...
        if (force || file.getName().endsWith(".xsb")) {
            try {
                ...
                dump(Files.newInputStream(file.toPath(), new OpenOption[0]), "  ");
                System.out.println();
            } catch (IOException e) {
    ...
    public static /* synthetic */ boolean lambda$dump$0(File file1) {
        return file1.isDirectory() || (file1.isFile() && file1.getName().endsWith(".xsb"));
    }
