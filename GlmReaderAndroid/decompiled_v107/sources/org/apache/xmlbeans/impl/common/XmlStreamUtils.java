...
public final class XmlStreamUtils {
    public static String printEvent(XMLStreamReader xmlr) {
        ...
        switch (xmlr.getEventType()) {
            case 1:
                ...
                for (int i = 0; i < xmlr.getNamespaceCount(); i++) {
                    ...
                    if (Sax2Dom.XMLNS_PREFIX.equals(n)) {
            ...
            case 2:
                ...
                for (int i3 = 0; i3 < xmlr.getNamespaceCount(); i3++) {
                    ...
                    if (Sax2Dom.XMLNS_PREFIX.equals(n2)) {
                        b.append("xmlns=\"" + xmlr.getNamespaceURI(i3) + "\"");
                    } else {
            ...
            case 3:
                ...
                b.append("<?");
                b.append(target + StringUtils.SPACE + data);
                b.append("?>");
                break;
            case 4:
            case 6:
            ...
            case 9:
                ...
                if (xmlr.hasText()) {
                    b.append(CollectionUtils.DEFAULT_TOSTRING_PREFIX + xmlr.getText() + CollectionUtils.DEFAULT_TOSTRING_SUFFIX);
                    break;
                }
                break;
            case 12:
        ...
        b.append(CollectionUtils.DEFAULT_TOSTRING_SUFFIX);
        return b.toString();
    }
