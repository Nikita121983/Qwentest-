...
public class XmlError implements Serializable {
    ...
    public XmlError(String message, String code, int severity, XmlCursor cursor) {
        this._offset = -1;
        String source = null;
        int line = -1;
        int column = -1;
        ...
        if (cursor != null) {
            ...
            try {
                ...
                ln = ln == null ? (XmlLineNumber) c.toPrevBookmark(XmlLineNumber.class) : ln;
                if (ln != null) {
                    line = ln.getLine();
                    column = ln.getColumn();
                    offset = ln.getOffset();
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public XmlError(String code, Object[] args, int severity, XmlCursor cursor) {
        this(formattedMessage(code, args), code, severity, cursor);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public XmlError(String message, String code, int severity, Location loc) {
        this._offset = -1;
        String source = null;
        int line = -1;
        int column = -1;
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public XmlError(String code, Object[] args, int severity, Location loc) {
    ...
    protected static String formattedFileName(String rawString, URI base) {
        ...
        if (!uri.isAbsolute() ? !(base == null || !base.isAbsolute() || base.getScheme().compareToIgnoreCase("file") != 0) : uri.getScheme().compareToIgnoreCase("file") == 0) {
            try {
