...
public class ParameterizedMessage implements Message, StringBuilderFormattable {
    ...
    static {
        FORMAT_BUFFER_HOLDER_REF = Constants.ENABLE_THREADLOCALS ? ThreadLocal.withInitial(new Supplier() { // from class: org.apache.logging.log4j.message.ParameterizedMessage$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return ParameterizedMessage.lambda$static$0();
            }
        }) : null;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ FormatBufferHolder lambda$static$0() {
    ...
    public ParameterizedMessage(final String pattern, final String[] args, final Throwable throwable) {
        this(pattern, Arrays.stream(args).toArray(new IntFunction() { // from class: org.apache.logging.log4j.message.ParameterizedMessage$$ExternalSyntheticLambda1
            @Override // java.util.function.IntFunction
            public final Object apply(int i) {
                return ParameterizedMessage.lambda$new$1(i);
            }
        }), throwable);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ Object[] lambda$new$1(int x$0) {
    ...
    public int hashCode() {
        ...
        return (result * 31) + (this.args != null ? Arrays.hashCode(this.args) : 0);
    }
    ...
    private void writeObject(final ObjectOutputStream out) throws IOException {
        ...
        for (Object arg : this.args) {
            Serializable serializableArg = arg instanceof Serializable ? (Serializable) arg : String.valueOf(arg);
