...
public final class MarkerManager {
    ...
    public static Marker getMarker(final String name) {
        return MARKERS.computeIfAbsent(name, new Function() { // from class: org.apache.logging.log4j.MarkerManager$$ExternalSyntheticLambda0
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return new MarkerManager.Log4jMarker((String) obj);
            }
        });
    }
        ...
        public boolean isInstanceOf(final Marker marker) {
            ...
            if (localParents != null) {
                ...
                if (localParentsLength == 2) {
                    if (checkParent(localParents[0], marker) || checkParent(localParents[1], marker)) {
                        return true;
                    }
                    return false;
                }
