    ...
    public String prettyPrint() {
        ...
        if (this.validationType != 0) {
            ...
            if (this.validationType != 3 || this.explicitListOfValues == null) {
                builder.append("").append(this.formula1).append("").append(Chars.SPACE);
            } else {
                builder.append("").append(Arrays.asList(this.explicitListOfValues)).append("").append(Chars.SPACE);
            }
            if (this.formula2 != null) {
                builder.append("").append(this.formula2).append("").append(Chars.SPACE);
            }
        }
