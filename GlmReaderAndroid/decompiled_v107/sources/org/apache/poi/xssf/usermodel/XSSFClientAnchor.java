...
public class XSSFClientAnchor extends XSSFAnchor implements ClientAnchor {
    ...
    public XSSFClientAnchor(int dx1, int dy1, int dx2, int dy2, int col1, int row1, int col2, int row2) {
        ...
        this.cell1.setColOff(Integer.valueOf(dx1));
        this.cell1.setRow(row1);
        this.cell1.setRowOff(Integer.valueOf(dy1));
        this.cell2 = CTMarker.Factory.newInstance();
        this.cell2.setCol(col2);
        this.cell2.setColOff(Integer.valueOf(dx2));
        this.cell2.setRow(row2);
        this.cell2.setRowOff(Integer.valueOf(dy2));
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public XSSFClientAnchor(CTMarker cell1, CTMarker cell2) {
        this.anchorType = ClientAnchor.AnchorType.MOVE_AND_RESIZE;
        this.cell1 = cell1;
        this.cell2 = cell2;
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public XSSFClientAnchor(XSSFSheet sheet, CTMarker cell1, CTPositiveSize2D size) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public XSSFClientAnchor(XSSFSheet sheet, CTPoint2D position, CTPositiveSize2D size) {
    ...
    private CTMarker calcCell(CTMarker cell, long w, long h) {
        ...
        c2.setCol(c);
        c2.setColOff(Long.valueOf(cw - (wPos - w)));
        ...
        c2.setRow(r);
        c2.setRowOff(Long.valueOf(rh - (hPos - h)));
        return c2;
    }
