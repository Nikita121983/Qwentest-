...
public enum EscherPropertyTypes {
    ...
    GEOMETRY__PFRAGMENTS(TarConstants.XSTAR_PREFIX_OFFSET, "geometry.pFragments"),
    ...
    LINESTYLE__LINESTARTARROWHEAD(TarConstants.XSTAR_MULTIVOLUME_OFFSET, "linestyle.linestartarrowhead"),
    ...
    private static final Map<Short, EscherPropertyTypes> LOOKUP = Collections.unmodifiableMap((Map) Stream.of((Object[]) values()).collect(Collectors.toMap(new Function() { // from class: org.apache.poi.ddf.EscherPropertyTypes$$ExternalSyntheticLambda0
    ...
    public static EscherPropertyTypes forPropertyID(int propertyId) {
        EscherPropertyTypes rt = LOOKUP.get(Short.valueOf((short) (propertyId & 16383)));
