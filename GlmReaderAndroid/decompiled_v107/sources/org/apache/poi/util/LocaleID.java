...
public enum LocaleID {
    ...
    NO(20, BooleanUtils.NO, BooleanUtils.NO, "Norwegian", 1252, -1),
    ...
    private static final Map<String, LocaleID> languageTagLookup = Collections.unmodifiableMap((Map) Stream.of((Object[]) values()).filter(new Predicate() { // from class: org.apache.poi.util.LocaleID$$ExternalSyntheticLambda0
        @Override // java.util.function.Predicate
        public final boolean test(Object obj) {
            boolean isValid;
            isValid = ((LocaleID) obj).isValid();
            return isValid;
        }
    }).collect(Collectors.toMap(new Function() { // from class: org.apache.poi.util.LocaleID$$ExternalSyntheticLambda1
        @Override // java.util.function.Function
        public final Object apply(Object obj) {
            return ((LocaleID) obj).getLanguageTag();
        }
    }, Function.identity())));
    private static final Map<Integer, LocaleID> lcidLookup = Collections.unmodifiableMap((Map) Stream.of((Object[]) values()).collect(Collectors.toMap(new Function() { // from class: org.apache.poi.util.LocaleID$$ExternalSyntheticLambda2
        @Override // java.util.function.Function
        public final Object apply(Object obj) {
    ...
    public static LocaleID lookupByLcid(int lcid) {
        return lcidLookup.get(Integer.valueOf(lcid));
    }
}
