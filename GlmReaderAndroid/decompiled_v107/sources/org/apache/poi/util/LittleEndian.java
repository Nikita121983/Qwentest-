...
public final class LittleEndian implements LittleEndianConsts {
    ...
    public static int getInt(byte[] data, int offset) {
        ...
        int i3 = i2 + 1;
        int b2 = data[i2] & 255;
        int b3 = data[i3] & UByte.MAX_VALUE;
    ...
    public static long getLong(byte[] data, int offset) {
        long result = data[offset + 7] & UByte.MAX_VALUE;
        for (int j = (offset + 8) - 1; j >= offset; j--) {
            result = (result << 8) | (data[j] & UByte.MAX_VALUE);
        }
        return result;
    }
    ...
    public static short getUByte(byte[] data) {
        return (short) (data[0] & UByte.MAX_VALUE);
    }

    public static short getUByte(byte[] data, int offset) {
        return (short) (data[offset] & UByte.MAX_VALUE);
    }
    ...
    public static void putLong(byte[] data, int offset, long value) {
        ...
        data[offset + 7] = (byte) (255 & (value >>> 56));
    }
    ...
    public static void putLong(long value, OutputStream outputStream) throws IOException {
        ...
        outputStream.write((byte) (255 & (value >>> 56)));
    }
    ...
    public static void putUInt(long value, OutputStream outputStream) throws IOException {
        ...
        outputStream.write((byte) ((value >>> 8) & 255));
        outputStream.write((byte) ((value >>> 16) & 255));
        outputStream.write((byte) (255 & (value >>> 24)));
    }
