...
public class CodePageString {
    ...
    private static final Logger LOG = PoiLogManager.getLogger((Class<?>) CodePageString.class);
    ...
    public void read(LittleEndianByteArrayInputStream lei) {
        ...
        if (this._value[size - 1] != 0) {
            LOG.atWarn().log("CodePageString started at offset #{} is not NULL-terminated", Unbox.box(offset));
        }
