...
public class TypedPropertyValue {
    ...
    public void read(LittleEndianByteArrayInputStream lei) {
        ...
        if (padding != 0) {
            LOG.atWarn().log("TypedPropertyValue padding at offset {} MUST be 0, but it's value is {}", Unbox.box(lei.getReadIndex()), Unbox.box(padding));
        }
        readValue(lei);
    }
    ...
    public static void skipPadding(LittleEndianByteArrayInputStream lei) {
