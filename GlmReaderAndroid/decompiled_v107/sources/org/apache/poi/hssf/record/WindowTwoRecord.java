...
public final class WindowTwoRecord extends StandardRecord {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        return GenericRecordUtil.getGenericProperties("options", GenericRecordUtil.getBitsAsString((Supplier<Number>) new Supplier() { // from class: org.apache.poi.hssf.record.WindowTwoRecord$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(WindowTwoRecord.this.getOptions());
            }
        }, new BitField[]{displayFormulas, displayGridlines, displayRowColHeadings, freezePanes, displayZeros, defaultHeader, arabic, displayGuts, freezePanesNoSplit, selected, active, savedInPageBreakPreview}, new String[]{"DISPLAY_FORMULAS", "DISPLAY_GRIDLINES", "DISPLAY_ROW_COL_HEADINGS", "FREEZE_PANES", "DISPLAY_ZEROS", "DEFAULT_HEADER", "ARABIC", "DISPLAY_GUTS", "FREEZE_PANES_NO_SPLIT", "SELECTED", "ACTIVE", "SAVED_IN_PAGE_BREAK_PREVIEW"}), "topRow", new Supplier() { // from class: org.apache.poi.hssf.record.WindowTwoRecord$$ExternalSyntheticLambda1
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(WindowTwoRecord.this.getTopRow());
            }
        }, "leftCol", new Supplier() { // from class: org.apache.poi.hssf.record.WindowTwoRecord$$ExternalSyntheticLambda2
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(WindowTwoRecord.this.getLeftCol());
            }
        }, "headerColor", new Supplier() { // from class: org.apache.poi.hssf.record.WindowTwoRecord$$ExternalSyntheticLambda3
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(WindowTwoRecord.this.getHeaderColor());
            }
        }, "pageBreakZoom", new Supplier() { // from class: org.apache.poi.hssf.record.WindowTwoRecord$$ExternalSyntheticLambda4
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(WindowTwoRecord.this.getPageBreakZoom());
            }
        }, "normalZoom", new Supplier() { // from class: org.apache.poi.hssf.record.WindowTwoRecord$$ExternalSyntheticLambda5
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(WindowTwoRecord.this.getNormalZoom());
            }
        }, "reserved", new Supplier() { // from class: org.apache.poi.hssf.record.WindowTwoRecord$$ExternalSyntheticLambda6
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(WindowTwoRecord.this.getReserved());
            }
        });
    }
}
