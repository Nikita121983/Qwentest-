...
public final class AxisOptionsRecord extends StandardRecord {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        return GenericRecordUtil.getGenericProperties("minimumCategory", new Supplier() { // from class: org.apache.poi.hssf.record.chart.AxisOptionsRecord$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(AxisOptionsRecord.this.getMinimumCategory());
            }
        }, "maximumCategory", new Supplier() { // from class: org.apache.poi.hssf.record.chart.AxisOptionsRecord$$ExternalSyntheticLambda1
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(AxisOptionsRecord.this.getMaximumCategory());
            }
        }, "majorUnitValue", new Supplier() { // from class: org.apache.poi.hssf.record.chart.AxisOptionsRecord$$ExternalSyntheticLambda2
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(AxisOptionsRecord.this.getMajorUnitValue());
            }
        }, "majorUnit", new Supplier() { // from class: org.apache.poi.hssf.record.chart.AxisOptionsRecord$$ExternalSyntheticLambda3
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(AxisOptionsRecord.this.getMajorUnit());
            }
        }, "minorUnitValue", new Supplier() { // from class: org.apache.poi.hssf.record.chart.AxisOptionsRecord$$ExternalSyntheticLambda4
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(AxisOptionsRecord.this.getMinorUnitValue());
            }
        }, "minorUnit", new Supplier() { // from class: org.apache.poi.hssf.record.chart.AxisOptionsRecord$$ExternalSyntheticLambda5
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(AxisOptionsRecord.this.getMinorUnit());
            }
        }, "baseUnit", new Supplier() { // from class: org.apache.poi.hssf.record.chart.AxisOptionsRecord$$ExternalSyntheticLambda6
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(AxisOptionsRecord.this.getBaseUnit());
            }
        }, "crossingPoint", new Supplier() { // from class: org.apache.poi.hssf.record.chart.AxisOptionsRecord$$ExternalSyntheticLambda7
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(AxisOptionsRecord.this.getCrossingPoint());
            }
        }, "options", GenericRecordUtil.getBitsAsString((Supplier<Number>) new Supplier() { // from class: org.apache.poi.hssf.record.chart.AxisOptionsRecord$$ExternalSyntheticLambda8
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(AxisOptionsRecord.this.getOptions());
            }
