...
public final class ValueRangeRecord extends StandardRecord {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        return GenericRecordUtil.getGenericProperties("minimumAxisValue", new Supplier() { // from class: org.apache.poi.hssf.record.chart.ValueRangeRecord$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return Double.valueOf(ValueRangeRecord.this.getMinimumAxisValue());
            }
        }, "maximumAxisValue", new Supplier() { // from class: org.apache.poi.hssf.record.chart.ValueRangeRecord$$ExternalSyntheticLambda1
            @Override // java.util.function.Supplier
            public final Object get() {
                return Double.valueOf(ValueRangeRecord.this.getMaximumAxisValue());
            }
        }, "majorIncrement", new Supplier() { // from class: org.apache.poi.hssf.record.chart.ValueRangeRecord$$ExternalSyntheticLambda2
            @Override // java.util.function.Supplier
            public final Object get() {
                return Double.valueOf(ValueRangeRecord.this.getMajorIncrement());
            }
        }, "minorIncrement", new Supplier() { // from class: org.apache.poi.hssf.record.chart.ValueRangeRecord$$ExternalSyntheticLambda3
            @Override // java.util.function.Supplier
            public final Object get() {
                return Double.valueOf(ValueRangeRecord.this.getMinorIncrement());
            }
        }, "categoryAxisCross", new Supplier() { // from class: org.apache.poi.hssf.record.chart.ValueRangeRecord$$ExternalSyntheticLambda4
            @Override // java.util.function.Supplier
            public final Object get() {
                return Double.valueOf(ValueRangeRecord.this.getCategoryAxisCross());
            }
        }, "options", GenericRecordUtil.getBitsAsString((Supplier<Number>) new Supplier() { // from class: org.apache.poi.hssf.record.chart.ValueRangeRecord$$ExternalSyntheticLambda5
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(ValueRangeRecord.this.getOptions());
            }
