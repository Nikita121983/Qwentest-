...
public final class FtPioGrbitSubRecord extends SubRecord {
    ...
    public FtPioGrbitSubRecord(LittleEndianInput in, int size, int cmoOt) {
        if (size != 2) {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        return GenericRecordUtil.getGenericProperties("flags", GenericRecordUtil.getBitsAsString((Supplier<Number>) new Supplier() { // from class: org.apache.poi.hssf.record.FtPioGrbitSubRecord$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(FtPioGrbitSubRecord.this.getFlags());
            }
