...
public final class DataFormatRecord extends StandardRecord {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        return GenericRecordUtil.getGenericProperties("pointNumber", new Supplier() { // from class: org.apache.poi.hssf.record.chart.DataFormatRecord$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(DataFormatRecord.this.getPointNumber());
            }
        }, "seriesIndex", new Supplier() { // from class: org.apache.poi.hssf.record.chart.DataFormatRecord$$ExternalSyntheticLambda1
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(DataFormatRecord.this.getSeriesIndex());
            }
        }, "seriesNumber", new Supplier() { // from class: org.apache.poi.hssf.record.chart.DataFormatRecord$$ExternalSyntheticLambda2
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(DataFormatRecord.this.getSeriesNumber());
            }
        }, "formatFlags", new Supplier() { // from class: org.apache.poi.hssf.record.chart.DataFormatRecord$$ExternalSyntheticLambda3
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(DataFormatRecord.this.getFormatFlags());
            }
        }, "useExcel4Colors", new Supplier() { // from class: org.apache.poi.hssf.record.chart.DataFormatRecord$$ExternalSyntheticLambda4
            @Override // java.util.function.Supplier
            public final Object get() {
