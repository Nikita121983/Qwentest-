...
public final class AreaFormatRecord extends StandardRecord {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        ...
        m.put("foregroundColor", new Supplier() { // from class: org.apache.poi.hssf.record.chart.AreaFormatRecord$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(AreaFormatRecord.this.getForegroundColor());
            }
        });
        m.put("backgroundColor", new Supplier() { // from class: org.apache.poi.hssf.record.chart.AreaFormatRecord$$ExternalSyntheticLambda1
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(AreaFormatRecord.this.getBackgroundColor());
            }
        });
        m.put("pattern", new Supplier() { // from class: org.apache.poi.hssf.record.chart.AreaFormatRecord$$ExternalSyntheticLambda2
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(AreaFormatRecord.this.getPattern());
            }
        });
        m.put("inverted", new Supplier() { // from class: org.apache.poi.hssf.record.chart.AreaFormatRecord$$ExternalSyntheticLambda3
            @Override // java.util.function.Supplier
            public final Object get() {
                return Boolean.valueOf(AreaFormatRecord.this.isInvert());
            }
        });
        m.put("automatic", new Supplier() { // from class: org.apache.poi.hssf.record.chart.AreaFormatRecord$$ExternalSyntheticLambda4
            @Override // java.util.function.Supplier
            public final Object get() {
                return Boolean.valueOf(AreaFormatRecord.this.isAutomatic());
            }
        });
        m.put("formatFlags", new Supplier() { // from class: org.apache.poi.hssf.record.chart.AreaFormatRecord$$ExternalSyntheticLambda5
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(AreaFormatRecord.this.getFormatFlags());
            }
        });
        m.put("forecolorIndex", new Supplier() { // from class: org.apache.poi.hssf.record.chart.AreaFormatRecord$$ExternalSyntheticLambda6
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(AreaFormatRecord.this.getForecolorIndex());
            }
        });
        m.put("backcolorIndex", new Supplier() { // from class: org.apache.poi.hssf.record.chart.AreaFormatRecord$$ExternalSyntheticLambda7
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(AreaFormatRecord.this.getBackcolorIndex());
            }
        });
