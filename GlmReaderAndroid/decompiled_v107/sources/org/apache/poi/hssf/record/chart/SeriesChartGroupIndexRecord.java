...
public final class SeriesChartGroupIndexRecord extends StandardRecord {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        return GenericRecordUtil.getGenericProperties("chartGroupIndex", new Supplier() { // from class: org.apache.poi.hssf.record.chart.SeriesChartGroupIndexRecord$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(SeriesChartGroupIndexRecord.this.getChartGroupIndex());
            }
        });
    }
}
