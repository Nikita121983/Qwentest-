...
public final class ObjectLinkRecord extends StandardRecord {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        return GenericRecordUtil.getGenericProperties("anchorId", GenericRecordUtil.getEnumBitsAsString(new Supplier() { // from class: org.apache.poi.hssf.record.chart.ObjectLinkRecord$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(ObjectLinkRecord.this.getAnchorId());
            }
        }, new int[]{1, 2, 3, 4, 7}, new String[]{"CHART_TITLE", "Y_AXIS", "X_AXIS", "SERIES_OR_POINT", "Z_AXIS"}), "link1", new Supplier() { // from class: org.apache.poi.hssf.record.chart.ObjectLinkRecord$$ExternalSyntheticLambda1
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(ObjectLinkRecord.this.getLink1());
            }
        }, "link2", new Supplier() { // from class: org.apache.poi.hssf.record.chart.ObjectLinkRecord$$ExternalSyntheticLambda2
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(ObjectLinkRecord.this.getLink2());
            }
        });
    }
}
