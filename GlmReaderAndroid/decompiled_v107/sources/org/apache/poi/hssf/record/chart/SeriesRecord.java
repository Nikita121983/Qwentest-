...
public final class SeriesRecord extends StandardRecord {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        return GenericRecordUtil.getGenericProperties("categoryDataType", new Supplier() { // from class: org.apache.poi.hssf.record.chart.SeriesRecord$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(SeriesRecord.this.getCategoryDataType());
            }
        }, "valuesDataType", new Supplier() { // from class: org.apache.poi.hssf.record.chart.SeriesRecord$$ExternalSyntheticLambda1
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(SeriesRecord.this.getValuesDataType());
            }
        }, "numCategories", new Supplier() { // from class: org.apache.poi.hssf.record.chart.SeriesRecord$$ExternalSyntheticLambda2
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(SeriesRecord.this.getNumCategories());
            }
        }, "numValues", new Supplier() { // from class: org.apache.poi.hssf.record.chart.SeriesRecord$$ExternalSyntheticLambda3
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(SeriesRecord.this.getNumValues());
            }
        }, "bubbleSeriesType", new Supplier() { // from class: org.apache.poi.hssf.record.chart.SeriesRecord$$ExternalSyntheticLambda4
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(SeriesRecord.this.getBubbleSeriesType());
            }
        }, "numBubbleValues", new Supplier() { // from class: org.apache.poi.hssf.record.chart.SeriesRecord$$ExternalSyntheticLambda5
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(SeriesRecord.this.getNumBubbleValues());
            }
        });
    }
}
