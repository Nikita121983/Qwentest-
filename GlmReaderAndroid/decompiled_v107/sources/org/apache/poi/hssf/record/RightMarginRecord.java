...
public final class RightMarginRecord extends StandardRecord implements Margin {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        return GenericRecordUtil.getGenericProperties("margin", new Supplier() { // from class: org.apache.poi.hssf.record.RightMarginRecord$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return Double.valueOf(RightMarginRecord.this.getMargin());
            }
        });
    }
}
