...
public final class TextRecord extends StandardRecord {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        ...
        m.put("horizontalAlignment", GenericRecordUtil.getEnumBitsAsString(new Supplier() { // from class: org.apache.poi.hssf.record.chart.TextRecord$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return Byte.valueOf(TextRecord.this.getHorizontalAlignment());
            }
        }, new int[]{1, 2, 3, 4}, new String[]{"LEFT", "CENTER", "BOTTOM", "JUSTIFY"}));
        m.put(CellUtil.VERTICAL_ALIGNMENT, GenericRecordUtil.getEnumBitsAsString(new Supplier() { // from class: org.apache.poi.hssf.record.chart.TextRecord$$ExternalSyntheticLambda9
            @Override // java.util.function.Supplier
            public final Object get() {
                return Byte.valueOf(TextRecord.this.getVerticalAlignment());
            }
        }, new int[]{1, 2, 3, 4}, new String[]{"TOP", "CENTER", "BOTTOM", "JUSTIFY"}));
        m.put("displayMode", GenericRecordUtil.getEnumBitsAsString(new Supplier() { // from class: org.apache.poi.hssf.record.chart.TextRecord$$ExternalSyntheticLambda10
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(TextRecord.this.getDisplayMode());
            }
        }, new int[]{1, 2}, new String[]{"TRANSPARENT", "OPAQUE"}));
        m.put("rgbColor", new Supplier() { // from class: org.apache.poi.hssf.record.chart.TextRecord$$ExternalSyntheticLambda11
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(TextRecord.this.getRgbColor());
            }
        });
        m.put("x", new Supplier() { // from class: org.apache.poi.hssf.record.chart.TextRecord$$ExternalSyntheticLambda12
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(TextRecord.this.getX());
            }
        });
        m.put("y", new Supplier() { // from class: org.apache.poi.hssf.record.chart.TextRecord$$ExternalSyntheticLambda13
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(TextRecord.this.getY());
            }
        });
        m.put("width", new Supplier() { // from class: org.apache.poi.hssf.record.chart.TextRecord$$ExternalSyntheticLambda1
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(TextRecord.this.getWidth());
            }
        });
        m.put("height", new Supplier() { // from class: org.apache.poi.hssf.record.chart.TextRecord$$ExternalSyntheticLambda2
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(TextRecord.this.getHeight());
            }
        });
        m.put("options1", GenericRecordUtil.getBitsAsString((Supplier<Number>) new Supplier() { // from class: org.apache.poi.hssf.record.chart.TextRecord$$ExternalSyntheticLambda3
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(TextRecord.this.getOptions1());
            }
        ...
        m.put("rotation", GenericRecordUtil.getEnumBitsAsString(new Supplier() { // from class: org.apache.poi.hssf.record.chart.TextRecord$$ExternalSyntheticLambda4
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(TextRecord.this.getRotation());
            }
        }, new int[]{0, 1, 2, 3}, new String[]{"NONE", "TOP_TO_BOTTOM", "ROTATED_90_DEGREES", "ROTATED_90_DEGREES_CLOCKWISE"}));
        m.put("options2", new Supplier() { // from class: org.apache.poi.hssf.record.chart.TextRecord$$ExternalSyntheticLambda5
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(TextRecord.this.getOptions2());
            }
        });
        m.put("dataLabelPlacement", GenericRecordUtil.getEnumBitsAsString(new Supplier() { // from class: org.apache.poi.hssf.record.chart.TextRecord$$ExternalSyntheticLambda6
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(TextRecord.this.getDataLabelPlacement());
            }
        ...
        m.put("indexOfColorValue", new Supplier() { // from class: org.apache.poi.hssf.record.chart.TextRecord$$ExternalSyntheticLambda7
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(TextRecord.this.getIndexOfColorValue());
            }
        });
        m.put("textRotation", new Supplier() { // from class: org.apache.poi.hssf.record.chart.TextRecord$$ExternalSyntheticLambda8
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(TextRecord.this.getTextRotation());
            }
        });
