...
public final class RowRecord extends StandardRecord {
    ...
    public void serialize(LittleEndianOutput out) {
        ...
        out.writeShort(getLastCol() != -1 ? getLastCol() : 0);
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        ...
        m.put("rowNumber", new Supplier() { // from class: org.apache.poi.hssf.record.RowRecord$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(RowRecord.this.getRowNumber());
            }
        });
        m.put("firstCol", new Supplier() { // from class: org.apache.poi.hssf.record.RowRecord$$ExternalSyntheticLambda1
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(RowRecord.this.getFirstCol());
            }
        });
        m.put("lastCol", new Supplier() { // from class: org.apache.poi.hssf.record.RowRecord$$ExternalSyntheticLambda2
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(RowRecord.this.getLastCol());
            }
        });
        m.put("height", new Supplier() { // from class: org.apache.poi.hssf.record.RowRecord$$ExternalSyntheticLambda3
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(RowRecord.this.getHeight());
            }
        });
        m.put("optimized", new Supplier() { // from class: org.apache.poi.hssf.record.RowRecord$$ExternalSyntheticLambda4
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(RowRecord.this.getOptimize());
            }
        });
        m.put("reserved", new Supplier() { // from class: org.apache.poi.hssf.record.RowRecord$$ExternalSyntheticLambda5
            @Override // java.util.function.Supplier
            public final Object get() {
                return RowRecord.this.m2366x4aaccdcc();
            }
        });
        m.put("options", GenericRecordUtil.getBitsAsString((Supplier<Number>) new Supplier() { // from class: org.apache.poi.hssf.record.RowRecord$$ExternalSyntheticLambda6
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(RowRecord.this.getOptionFlags());
            }
        }, new BitField[]{collapsed, zeroHeight, badFontHeight, formatted}, new String[]{"COLAPSED", "ZERO_HEIGHT", "BAD_FONT_HEIGHT", "FORMATTED"}));
        m.put("outlineLevel", new Supplier() { // from class: org.apache.poi.hssf.record.RowRecord$$ExternalSyntheticLambda7
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(RowRecord.this.getOutlineLevel());
            }
        });
        m.put("optionFlags2", GenericRecordUtil.getBitsAsString((Supplier<Number>) new Supplier() { // from class: org.apache.poi.hssf.record.RowRecord$$ExternalSyntheticLambda8
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(RowRecord.this.getOptionFlags2());
            }
        }, new BitField[]{topBorder, bottomBorder, phoneticGuide}, new String[]{"TOP_BORDER", "BOTTOM_BORDER", "PHOENETIC_GUIDE"}));
        m.put("xfIndex", new Supplier() { // from class: org.apache.poi.hssf.record.RowRecord$$ExternalSyntheticLambda9
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(RowRecord.this.getXFIndex());
            }
        });
    ...
    public /* synthetic */ Object m2366x4aaccdcc() {
