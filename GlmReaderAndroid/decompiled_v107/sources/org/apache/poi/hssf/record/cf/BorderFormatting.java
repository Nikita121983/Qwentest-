...
public final class BorderFormatting implements Duplicatable, GenericRecord {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        ...
        m.put(CellUtil.BORDER_LEFT, new Supplier() { // from class: org.apache.poi.hssf.record.cf.BorderFormatting$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(BorderFormatting.this.getBorderLeft());
            }
        });
        m.put(CellUtil.BORDER_RIGHT, new Supplier() { // from class: org.apache.poi.hssf.record.cf.BorderFormatting$$ExternalSyntheticLambda1
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(BorderFormatting.this.getBorderRight());
            }
        });
        m.put(CellUtil.BORDER_TOP, new Supplier() { // from class: org.apache.poi.hssf.record.cf.BorderFormatting$$ExternalSyntheticLambda2
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(BorderFormatting.this.getBorderTop());
            }
        });
        m.put(CellUtil.BORDER_BOTTOM, new Supplier() { // from class: org.apache.poi.hssf.record.cf.BorderFormatting$$ExternalSyntheticLambda3
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(BorderFormatting.this.getBorderBottom());
            }
        });
        m.put(CellUtil.LEFT_BORDER_COLOR, new Supplier() { // from class: org.apache.poi.hssf.record.cf.BorderFormatting$$ExternalSyntheticLambda4
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(BorderFormatting.this.getLeftBorderColor());
            }
        });
        m.put(CellUtil.RIGHT_BORDER_COLOR, new Supplier() { // from class: org.apache.poi.hssf.record.cf.BorderFormatting$$ExternalSyntheticLambda5
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(BorderFormatting.this.getRightBorderColor());
            }
        });
        m.put(CellUtil.TOP_BORDER_COLOR, new Supplier() { // from class: org.apache.poi.hssf.record.cf.BorderFormatting$$ExternalSyntheticLambda6
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(BorderFormatting.this.getTopBorderColor());
            }
        });
        m.put(CellUtil.BOTTOM_BORDER_COLOR, new Supplier() { // from class: org.apache.poi.hssf.record.cf.BorderFormatting$$ExternalSyntheticLambda7
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(BorderFormatting.this.getBottomBorderColor());
            }
        });
        m.put("forwardDiagonalOn", new Supplier() { // from class: org.apache.poi.hssf.record.cf.BorderFormatting$$ExternalSyntheticLambda8
            @Override // java.util.function.Supplier
            public final Object get() {
                return Boolean.valueOf(BorderFormatting.this.isForwardDiagonalOn());
            }
        });
        m.put("backwardDiagonalOn", new Supplier() { // from class: org.apache.poi.hssf.record.cf.BorderFormatting$$ExternalSyntheticLambda9
            @Override // java.util.function.Supplier
            public final Object get() {
                return Boolean.valueOf(BorderFormatting.this.isBackwardDiagonalOn());
            }
        });
