...
public final class CommonObjectDataSubRecord extends SubRecord {
    ...
    public CommonObjectDataSubRecord(LittleEndianInput in, int size, int cmoOt) {
        if (size != 18) {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        return GenericRecordUtil.getGenericProperties("objectType", new Supplier() { // from class: org.apache.poi.hssf.record.CommonObjectDataSubRecord$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(CommonObjectDataSubRecord.this.getObjectType());
            }
        }, "objectId", new Supplier() { // from class: org.apache.poi.hssf.record.CommonObjectDataSubRecord$$ExternalSyntheticLambda1
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(CommonObjectDataSubRecord.this.getObjectId());
            }
        }, "option", GenericRecordUtil.getBitsAsString((Supplier<Number>) new Supplier() { // from class: org.apache.poi.hssf.record.CommonObjectDataSubRecord$$ExternalSyntheticLambda2
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(CommonObjectDataSubRecord.this.getOption());
            }
        }, new BitField[]{locked, printable, autofill, autoline}, new String[]{"LOCKED", "PRINTABLE", "AUTOFILL", "AUTOLINE"}), "reserved1", new Supplier() { // from class: org.apache.poi.hssf.record.CommonObjectDataSubRecord$$ExternalSyntheticLambda3
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(CommonObjectDataSubRecord.this.getReserved1());
            }
        }, "reserved2", new Supplier() { // from class: org.apache.poi.hssf.record.CommonObjectDataSubRecord$$ExternalSyntheticLambda4
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(CommonObjectDataSubRecord.this.getReserved2());
            }
        }, "reserved3", new Supplier() { // from class: org.apache.poi.hssf.record.CommonObjectDataSubRecord$$ExternalSyntheticLambda5
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(CommonObjectDataSubRecord.this.getReserved3());
            }
        });
    }
}
