...
public final class TickRecord extends StandardRecord {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        ...
        m.put("majorTickType", new Supplier() { // from class: org.apache.poi.hssf.record.chart.TickRecord$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return Byte.valueOf(TickRecord.this.getMajorTickType());
            }
        });
        m.put("minorTickType", new Supplier() { // from class: org.apache.poi.hssf.record.chart.TickRecord$$ExternalSyntheticLambda3
            @Override // java.util.function.Supplier
            public final Object get() {
                return Byte.valueOf(TickRecord.this.getMinorTickType());
            }
        });
        m.put("labelPosition", new Supplier() { // from class: org.apache.poi.hssf.record.chart.TickRecord$$ExternalSyntheticLambda4
            @Override // java.util.function.Supplier
            public final Object get() {
                return Byte.valueOf(TickRecord.this.getLabelPosition());
            }
        });
        m.put("background", new Supplier() { // from class: org.apache.poi.hssf.record.chart.TickRecord$$ExternalSyntheticLambda5
            @Override // java.util.function.Supplier
            public final Object get() {
                return Byte.valueOf(TickRecord.this.getBackground());
            }
        });
        m.put("labelColorRgb", new Supplier() { // from class: org.apache.poi.hssf.record.chart.TickRecord$$ExternalSyntheticLambda6
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(TickRecord.this.getLabelColorRgb());
            }
        });
        m.put("zero1", new Supplier() { // from class: org.apache.poi.hssf.record.chart.TickRecord$$ExternalSyntheticLambda7
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(TickRecord.this.getZero1());
            }
        });
        m.put("zero2", new Supplier() { // from class: org.apache.poi.hssf.record.chart.TickRecord$$ExternalSyntheticLambda8
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(TickRecord.this.getZero2());
            }
        });
        m.put("options", GenericRecordUtil.getBitsAsString((Supplier<Number>) new Supplier() { // from class: org.apache.poi.hssf.record.chart.TickRecord$$ExternalSyntheticLambda9
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(TickRecord.this.getOptions());
            }
        }, new BitField[]{autoTextColor, autoTextBackground, autorotate}, new String[]{"AUTO_TEXT_COLOR", "AUTO_TEXT_BACKGROUND", "AUTO_ROTATE"}));
        m.put("rotation", new Supplier() { // from class: org.apache.poi.hssf.record.chart.TickRecord$$ExternalSyntheticLambda10
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(TickRecord.this.getRotation());
            }
        });
        m.put("tickColor", new Supplier() { // from class: org.apache.poi.hssf.record.chart.TickRecord$$ExternalSyntheticLambda1
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(TickRecord.this.getTickColor());
            }
        });
        m.put("zero3", new Supplier() { // from class: org.apache.poi.hssf.record.chart.TickRecord$$ExternalSyntheticLambda2
            @Override // java.util.function.Supplier
            public final Object get() {
                return Short.valueOf(TickRecord.this.getZero3());
            }
        });
