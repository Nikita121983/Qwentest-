...
public abstract class HSSFShape implements Shape {
        ...
        if (this.parent == null) {
            ...
            if (anch != null) {
                for (int i = 0; i < this._escherContainer.getChildCount(); i++) {
                    if (this._escherContainer.getChild(i).getRecordId() == EscherClientAnchorRecord.RECORD_ID && i != this._escherContainer.getChildCount() - 1) {
            ...
            if (anch2 != null) {
                for (int i2 = 0; i2 < this._escherContainer.getChildCount(); i2++) {
                    if (this._escherContainer.getChild(i2).getRecordId() == EscherChildAnchorRecord.RECORD_ID && i2 != this._escherContainer.getChildCount() - 1) {
    ...
    public void setNoFill(boolean noFill) {
        setPropertyValue(new EscherBoolProperty(EscherPropertyTypes.FILL__NOFILLHITTEST, noFill ? NO_FILLHITTEST_TRUE : 65536));
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public void setPropertyValue(EscherProperty property) {
    ...
    public int getRotationDegree() {
        EscherSimpleProperty property = (EscherSimpleProperty) getOptRecord().lookup(EscherPropertyTypes.TRANSFORM__ROTATION);
        if (property == null) {
            return 0;
        }
        byte[] buf = new byte[4];
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void setPatriarch(HSSFPatriarch _patriarch) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void setParent(HSSFShape parent) {
        this.parent = parent;
    }
