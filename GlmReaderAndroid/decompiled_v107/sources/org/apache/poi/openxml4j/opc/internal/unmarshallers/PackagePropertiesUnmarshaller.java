...
public final class PackagePropertiesUnmarshaller implements PartUnmarshaller {
    ...
    public void checkElementForOPCCompliance(Element el) throws InvalidFormatException {
        if (this.opcComplianceFlags.getForbidMarkupCompatibilityNamespace()) {
        ...
        if (this.opcComplianceFlags.getForbidRefiningDublinCoreElements() && "http://purl.org/dc/terms/".equals(el.getNamespaceURI()) && !KEYWORD_CREATED.equals(elName) && !KEYWORD_MODIFIED.equals(elName)) {
            throw new InvalidFormatException("OPC Compliance error [M4.3]: Producers shall not create a document element that contains refinements to the Dublin Core elements, except for the two specified in the schema: <dcterms:created> and <dcterms:modified> Consumers shall consider a document element that violates this constraint to be an error.");
        }
        if (this.opcComplianceFlags.getForbidXmlLangAttributes() && el.getAttributeNodeNS("http://www.w3.org/XML/1998/namespace", "lang") != null) {
        ...
        if (this.opcComplianceFlags.getRestrictXsiTypeAttribute() && "http://purl.org/dc/terms/".equals(el.getNamespaceURI())) {
            ...
            Attr typeAtt = el.getAttributeNodeNS("http://www.w3.org/2001/XMLSchema-instance", ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY);
            if (typeAtt == null) {
