...
public abstract class PackagePart implements RelationshipSource, Comparable<PackagePart> {
    ...
    public PackagePart(OPCPackage pack, PackagePartName partName, ContentType contentType, boolean loadRelationships) throws InvalidFormatException {
    ...
    public boolean hasRelationships() {
        return (this._isRelationshipPart || this._relationships == null || this._relationships.isEmpty()) ? false : true;
    }

    @Override // org.apache.poi.openxml4j.opc.RelationshipSource
    public boolean isRelationshipExists(PackageRelationship rel) {
        return (rel == null || this._relationships.getRelationshipByID(rel.getId()) == null) ? false : true;
    }
