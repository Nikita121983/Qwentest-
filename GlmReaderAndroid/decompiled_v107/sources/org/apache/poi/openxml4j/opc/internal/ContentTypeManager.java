...
public abstract class ContentTypeManager {
    ...
    public void addContentType(PackagePartName partName, String contentType) {
        ...
        if (extension.isEmpty() || ((this.defaultContentType.containsKey(extension) && !defaultCTExists) || (!this.defaultContentType.containsKey(extension) && defaultCTExists))) {
    ...
    public void removeContentType(PackagePartName partName) throws InvalidOperationException {
        ...
        if (this.container != null) {
            try {
                Iterator<PackagePart> it2 = this.container.getParts().iterator();
                while (it2.hasNext()) {
                    PackagePart part2 = it2.next();
