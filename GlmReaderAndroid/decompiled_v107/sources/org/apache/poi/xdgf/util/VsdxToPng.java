...
public class VsdxToPng {
    ...
    public static void renderToPngDir(XDGFPage page, File outDir, double scale, ShapeRenderer renderer) throws IOException {
        File pageFile = new File(outDir, "page" + page.getPageNumber() + ProcessIdUtil.DEFAULT_PROCESSID + Util.sanitizeFilename(page.getName()) + ".png");
    ...
    public static void renderToPng(XDGFPage page, File outFile, double scale, ShapeRenderer renderer) throws IOException {
        ...
        int width = (int) (sz.getWidth() * scale);
        int height = (int) (sz.getHeight() * scale);
        ...
        try {
            ImageIO.write(img, ContentTypes.EXTENSION_PNG, out);
            if (out != null) {
                out.close();
            }
        } catch (Throwable th) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            renderToPng(doc, pngDir, 181.8181818181818d, renderer);
            if (is != null) {
                is.close();
            }
        } catch (Throwable th) {
