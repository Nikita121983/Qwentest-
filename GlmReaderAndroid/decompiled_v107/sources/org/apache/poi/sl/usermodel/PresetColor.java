...
public final class PresetColor {
    ...
    static {
        ...
        ActiveCaptionText = new PresetColor("ActiveCaptionText", 2, valueOf, 3, "captionText");
        ...
        ControlDarkDark = new PresetColor("ControlDarkDark", 6, valueOf, 7, "3dDkShadow");
        ...
        ControlText = new PresetColor("ControlText", 9, valueOf, 10, "btnText");
        Desktop = new PresetColor("Desktop", 10, valueOf, 11, "background");
        ...
        InactiveCaptionText = new PresetColor("InactiveCaptionText", 17, valueOf, 18, "inactiveCaptionText");
        Info = new PresetColor("Info", 18, -31, 19, "infoBk");
        InfoText = new PresetColor("InfoText", 19, valueOf, 20, "infoText");
        Menu = new PresetColor("Menu", 20, -986896, 21, "menu");
        MenuText = new PresetColor("MenuText", 21, valueOf, 22, "menuText");
        ...
        WindowText = new PresetColor("WindowText", 25, valueOf, 26, "windowText");
        ...
        Black = new PresetColor("Black", 34, valueOf, 35, "black");
