...
public class ImageHeaderEMF {
    ...
    private static final Logger LOG = PoiLogManager.getLogger((Class<?>) ImageHeaderEMF.class);
    ...
    public ImageHeaderEMF(byte[] data, int off) {
        ...
        this.deviceBounds = new Rectangle(left, top, right - left == -1 ? 0 : right - left, bottom - top != -1 ? bottom - top : 0);
        String signature = new String(data, offset6 + 16, EMF_SIGNATURE.length(), LocaleUtil.CHARSET_1252);
