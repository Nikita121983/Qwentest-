...
public class DrawBackground extends DrawShape {
    ...
    public void draw(Graphics2D graphics) {
        ...
        final Rectangle2D.Double r1 = new Rectangle2D.Double(0.0d, 0.0d, pg.getWidth(), pg.getHeight());
        ...
        Rectangle2D anchor2 = getAnchor(graphics, (Rectangle2D) r1);
        if (fill != null) {
            graphics.setRenderingHint(Drawable.GRADIENT_SHAPE, r1);
