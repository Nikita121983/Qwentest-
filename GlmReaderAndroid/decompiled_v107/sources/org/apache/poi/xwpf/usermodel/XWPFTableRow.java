...
public class XWPFTableRow {
    ...
    public int getHeight() {
        ...
        return (int) Units.toDXA(POIXMLUnits.parseLength(properties.getTrHeightArray(0).xgetVal()));
    }
    ...
    public boolean isCantSplitRow() {
        ...
        boolean isCant = !onoff.isSetVal() || POIXMLUnits.parseOnOff(onoff.xgetVal());
        return isCant;
    }
    ...
    private boolean getRepeat() {
        ...
        boolean repeat = !rpt.isSetVal() || POIXMLUnits.parseOnOff(rpt.xgetVal());
        return repeat;
    }
