    ...
    public XWPFHeaderFooterPolicy(XWPFDocument doc, CTSectPr sectPr) {
        ...
        if (sectPr == null) {
            ...
            if (ctBody.isSetSectPr()) {
                addNewSectPr = ctBody.getSectPr();
            } else {
                addNewSectPr = ctBody.addNewSectPr();
            }
            sectPr = addNewSectPr;
        }
        this.doc = doc;
        ...
        for (int i = 0; i < sectPr.sizeOfHeaderReferenceArray(); i++) {
            ...
            XWPFHeader hdr = relatedPart instanceof XWPFHeader ? (XWPFHeader) relatedPart : null;
            try {
                type2 = ref.getType();
        ...
        for (int i2 = 0; i2 < sectPr.sizeOfFooterReferenceArray(); i2++) {
            ...
            XWPFFooter ftr = relatedPart2 instanceof XWPFFooter ? (XWPFFooter) relatedPart2 : null;
            try {
                type = ref2.getType();
