...
public abstract class POIXMLDocument extends POIXMLDocumentPart implements Closeable {
    ...
    public POIXMLDocument(OPCPackage pkg) {
        super(pkg);
        init(pkg);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public POIXMLDocument(OPCPackage pkg, String coreDocumentRel) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public PackagePart[] getRelatedByType(String contentType) throws InvalidFormatException {
        PackageRelationshipCollection partsC = getPackagePart().getRelationshipsByType(contentType);
        PackagePart[] parts = new PackagePart[partsC.size()];
        int count = 0;
        Iterator<PackageRelationship> it = partsC.iterator();
        while (it.hasNext()) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public final void load(POIXMLFactory factory) throws IOException {
