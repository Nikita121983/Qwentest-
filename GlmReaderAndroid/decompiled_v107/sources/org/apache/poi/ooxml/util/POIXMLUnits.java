...
public class POIXMLUnits {
    ...
    public static long parseLength(STCoordinate32 coordUnion) {
        return parseLengthInner(coordUnion, 1.0d);
    }
    ...
    public static long parseLength(STTextPoint coordUnion) {
        return parseLengthInner(coordUnion, 127.0d);
    }

    public static long parseLength(STTwipsMeasure coordUnion) {
        return parseLengthInner(coordUnion, 635.0d);
    }
    ...
    public static long parseLength(STHpsMeasure coordUnion) {
        return parseLengthInner(coordUnion, 25400.0d);
    }
    ...
    private static long parseLengthInner(XmlAnySimpleType coordUnion, double noUnitEmuFactor) {
        ...
        if (strVal.endsWith("mm")) {
            long emu = (long) (((digVal / 10.0d) / 2.5399999618530273d) * 914400.0d);
            return emu;
        }
        if (strVal.endsWith("cm")) {
            long emu2 = (long) ((digVal / 2.5399999618530273d) * 914400.0d);
            return emu2;
        }
        if (strVal.endsWith("in")) {
            long emu3 = (long) (914400.0d * digVal);
            return emu3;
        }
        if (strVal.endsWith("pc") || strVal.endsWith("pi")) {
            long emu4 = (long) (0.16599999368190765d * digVal * 914400.0d);
            return emu4;
        }
        if (strVal.endsWith("pt")) {
            long emu5 = (long) (12700.0d * digVal);
            return emu5;
        }
        long emu6 = (long) (digVal * noUnitEmuFactor);
        return emu6;
    }
