...
public class POIXMLProperties {
    ...
    private static final org.openxmlformats.schemas.officeDocument.x2006.extendedProperties.PropertiesDocument NEW_EXT_INSTANCE = org.openxmlformats.schemas.officeDocument.x2006.extendedProperties.PropertiesDocument.Factory.newInstance();
    ...
    public POIXMLProperties(OPCPackage docPackage) throws IOException, OpenXML4JException, XmlException {
        ...
        if (extRel.size() == 1) {
            ...
            if (this.extPart == null) {
                ...
                stream = this.extPart.getInputStream();
                try {
                    org.openxmlformats.schemas.officeDocument.x2006.extendedProperties.PropertiesDocument props = org.openxmlformats.schemas.officeDocument.x2006.extendedProperties.PropertiesDocument.Factory.parse(stream, POIXMLTypeLoader.DEFAULT_XML_OPTIONS);
        ...
        if (custRel.size() == 1) {
            ...
            stream = this.custPart.getInputStream();
            try {
                PropertiesDocument props2 = PropertiesDocument.Factory.parse(stream, POIXMLTypeLoader.DEFAULT_XML_OPTIONS);
    ...
    public static class CustomProperties {
        ...
        private CustomProperties(PropertiesDocument props) {
            this.lastPid = null;
            this.props = props;
        }
        ...
        protected int nextPid() {
            int propid = this.lastPid == null ? getLastPid() : this.lastPid.intValue();
            int nextid = propid + 1;
            this.lastPid = Integer.valueOf(nextid);
            return nextid;
        }
