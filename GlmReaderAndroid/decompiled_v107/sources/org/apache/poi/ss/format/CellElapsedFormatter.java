    ...
    public static class TimeSpec {
        ...
        public long valueFor(double elapsed) {
            ...
            if (this.modBy == 0.0d) {
                ...
                double val2 = this.factor;
                val = (elapsed / val2) % this.modBy;
            }
            if (this.type == '0' || this.type == 's') {
            ...
            switch (firstCh) {
                ...
                case '[':
                    if (part.length() >= 3) {
                        ...
                        return part3.substring(1, specLen + 1);
                    }
                    break;
                case '\\':
    ...
    private static double factorFor(char type, int len) {
        switch (type) {
            ...
            case 's':
                return SEC__FACTOR;
            default:
                throw new IllegalArgumentException("Unknown elapsed time spec: " + type);
        }
    }
