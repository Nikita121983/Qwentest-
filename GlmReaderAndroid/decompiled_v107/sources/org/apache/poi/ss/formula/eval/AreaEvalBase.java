...
public abstract class AreaEvalBase implements AreaEval {
    ...
    public AreaEvalBase(SheetRange sheets, int firstRow, int firstColumn, int lastRow, int lastColumn) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public AreaEvalBase(int firstRow, int firstColumn, int lastRow, int lastColumn) {
        this(null, firstRow, firstColumn, lastRow, lastColumn);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public AreaEvalBase(AreaI ptg) {
        this(ptg, null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public AreaEvalBase(AreaI ptg, SheetRange sheets) {
