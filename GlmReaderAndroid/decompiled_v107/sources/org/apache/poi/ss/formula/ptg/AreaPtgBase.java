...
public abstract class AreaPtgBase extends OperandPtg implements AreaI {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public AreaPtgBase(AreaPtgBase other) {
        super(other);
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public AreaPtgBase(AreaReference ar) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public AreaPtgBase(int firstRow, int lastRow, int firstColumn, int lastColumn, boolean firstRowRelative, boolean lastRowRelative, boolean firstColRelative, boolean lastColRelative) {
        if (lastRow >= firstRow) {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        return GenericRecordUtil.getGenericProperties("firstRow", new Supplier() { // from class: org.apache.poi.ss.formula.ptg.AreaPtgBase$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(AreaPtgBase.this.getFirstRow());
            }
        }, "firstRowRelative", new Supplier() { // from class: org.apache.poi.ss.formula.ptg.AreaPtgBase$$ExternalSyntheticLambda1
            @Override // java.util.function.Supplier
            public final Object get() {
                return Boolean.valueOf(AreaPtgBase.this.isFirstRowRelative());
            }
        }, "firstColumn", new Supplier() { // from class: org.apache.poi.ss.formula.ptg.AreaPtgBase$$ExternalSyntheticLambda2
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(AreaPtgBase.this.getFirstColumn());
            }
        }, "firstColRelative", new Supplier() { // from class: org.apache.poi.ss.formula.ptg.AreaPtgBase$$ExternalSyntheticLambda3
            @Override // java.util.function.Supplier
            public final Object get() {
                return Boolean.valueOf(AreaPtgBase.this.isFirstColRelative());
            }
        }, "lastRow", new Supplier() { // from class: org.apache.poi.ss.formula.ptg.AreaPtgBase$$ExternalSyntheticLambda4
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(AreaPtgBase.this.getLastRow());
            }
        }, "lastRowRelative", new Supplier() { // from class: org.apache.poi.ss.formula.ptg.AreaPtgBase$$ExternalSyntheticLambda5
            @Override // java.util.function.Supplier
            public final Object get() {
                return Boolean.valueOf(AreaPtgBase.this.isLastRowRelative());
            }
        }, "lastColumn", new Supplier() { // from class: org.apache.poi.ss.formula.ptg.AreaPtgBase$$ExternalSyntheticLambda6
            @Override // java.util.function.Supplier
            public final Object get() {
                return Integer.valueOf(AreaPtgBase.this.getLastColumn());
            }
        }, "lastColRelative", new Supplier() { // from class: org.apache.poi.ss.formula.ptg.AreaPtgBase$$ExternalSyntheticLambda7
            @Override // java.util.function.Supplier
            public final Object get() {
                return Boolean.valueOf(AreaPtgBase.this.isLastColRelative());
            }
        }, "formatReference", new Supplier() { // from class: org.apache.poi.ss.formula.ptg.AreaPtgBase$$ExternalSyntheticLambda8
            @Override // java.util.function.Supplier
            public final Object get() {
                return AreaPtgBase.this.formatReferenceAsString();
            }
        });
    }
}
