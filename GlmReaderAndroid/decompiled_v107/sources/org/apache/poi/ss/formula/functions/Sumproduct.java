...
public final class Sumproduct implements Function {
    ...
    public ValueEval evaluate(ValueEval[] args, int srcCellRow, int srcCellCol) {
        ...
        try {
            ...
            throw new IllegalStateException("Invalid arg type for SUMPRODUCT: (" + firstArg.getClass().getName() + ")");
    ...
    private static ValueEval evaluateAreaSumProduct(ValueEval[] evalArgs) throws EvaluationException {
        ...
        try {
            TwoDEval[] args = (TwoDEval[]) Arrays.copyOf(evalArgs, maxN, TwoDEval[].class);
    ...
    private static double getProductTerm(ValueEval ve, boolean isScalarProduct) throws EvaluationException {
        ...
        throw new IllegalStateException("Unexpected value eval class (" + ve.getClass().getName() + ")");
    }
}
