...
public final class AttrPtg extends ControlPtg {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        return GenericRecordUtil.getGenericProperties("volatile", new Supplier() { // from class: org.apache.poi.ss.formula.ptg.AttrPtg$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return Boolean.valueOf(AttrPtg.this.isSemiVolatile());
            }
        }, "options", GenericRecordUtil.getBitsAsString((Supplier<Number>) new Supplier() { // from class: org.apache.poi.ss.formula.ptg.AttrPtg$$ExternalSyntheticLambda1
            @Override // java.util.function.Supplier
            public final Object get() {
                return AttrPtg.this.m2544xbc2d42c6();
            }
        }, new BitField[]{semiVolatile, optiIf, optiChoose, optiSkip, optiSum, baxcel, space}, new String[]{"SEMI_VOLATILE", "OPTI_IF", "OPTI_CHOOSE", "OPTI_SKIP", "OPTI_SUM", "BAXCEL", "SPACE"}), "space_count", new Supplier() { // from class: org.apache.poi.ss.formula.ptg.AttrPtg$$ExternalSyntheticLambda2
            @Override // java.util.function.Supplier
            public final Object get() {
                return AttrPtg.this.m2545x852e3a07();
            }
        }, "space_type", GenericRecordUtil.getEnumBitsAsString(new Supplier() { // from class: org.apache.poi.ss.formula.ptg.AttrPtg$$ExternalSyntheticLambda3
            @Override // java.util.function.Supplier
            public final Object get() {
                return AttrPtg.this.m2546x4e2f3148();
            }
    ...
    public /* synthetic */ Number m2544xbc2d42c6() {
    ...
    public /* synthetic */ Object m2545x852e3a07() {
    ...
    public /* synthetic */ Number m2546x4e2f3148() {
