...
public final class LazyAreaEval extends AreaEvalBase {
    ...
    public String toString() {
        ...
        return getClass().getName() + CollectionUtils.DEFAULT_TOSTRING_PREFIX + this._evaluator.getSheetNameRange() + '!' + crA.formatAsString() + NameUtil.COLON + crB.formatAsString() + CollectionUtils.DEFAULT_TOSTRING_SUFFIX;
    }
