...
public final class Index implements Function2Arg, Function3Arg, Function4Arg, ArrayMode {
    ...
    public ValueEval evaluate(int srcRowIndex, int srcColumnIndex, ValueEval arg0, ValueEval arg1, ValueEval arg2, ValueEval arg3) {
        throw new IllegalStateException("Incomplete code - don't know how to support the 'area_num' parameter yet)");
    }
    ...
    private static TwoDEval convertFirstArg(ValueEval arg0) {
        ...
        throw new IllegalStateException("Incomplete code - cannot handle first arg of type (" + arg0.getClass().getName() + ")");
    }
