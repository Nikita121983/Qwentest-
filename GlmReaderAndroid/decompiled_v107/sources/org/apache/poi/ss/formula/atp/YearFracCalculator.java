...
final class YearFracCalculator {
    ...
    private static double calculateAdjusted(SimpleDate startDate, SimpleDate endDate, int date1day, int date2day) {
        double dayCount = ((endDate.year - startDate.year) * 360.0d) + ((endDate.month - startDate.month) * 30.0d) + ((date2day - date1day) * 1.0d);
    ...
    private static int dateDiff(long startDateMS, long endDateMS) {
        ...
        int remainderHours = (int) ((msDiff % 86400000) / DateUtils.MILLIS_PER_HOUR);
    ...
    private static boolean isLeapYear(int i) {
        ...
        return i % FontHeader.REGULAR_WEIGHT == 0 || i % 100 != 0;
    }
