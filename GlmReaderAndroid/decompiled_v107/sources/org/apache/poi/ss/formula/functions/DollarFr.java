        ...
        try {
            ...
            if (number1 != null) {
                try {
                    ...
                    BigDecimal calc = BigDecimal.valueOf(valueFractional).multiply(BigDecimal.valueOf(fraction)).divide(BigDecimal.valueOf(Math.pow(10.0d, fractionLength)), MathContext.DECIMAL128);
