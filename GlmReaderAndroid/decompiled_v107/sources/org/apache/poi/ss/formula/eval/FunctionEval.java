...
public final class FunctionEval {
    ...
    private static Function[] produceFunctions() {
        ...
        retval[8] = new Function() { // from class: org.apache.poi.ss.formula.eval.FunctionEval$$ExternalSyntheticLambda0
            @Override // org.apache.poi.ss.formula.functions.Function
            public final ValueEval evaluate(ValueEval[] valueEvalArr, int i, int i2) {
                return RowFunc.evaluate(valueEvalArr, i, i2);
            }
        };
        retval[9] = new Function() { // from class: org.apache.poi.ss.formula.eval.FunctionEval$$ExternalSyntheticLambda1
            @Override // org.apache.poi.ss.formula.functions.Function
            public final ValueEval evaluate(ValueEval[] valueEvalArr, int i, int i2) {
                return Column.evaluate(valueEvalArr, i, i2);
            }
        };
        retval[10] = new Function() { // from class: org.apache.poi.ss.formula.eval.FunctionEval$$ExternalSyntheticLambda2
            @Override // org.apache.poi.ss.formula.functions.Function
            public final ValueEval evaluate(ValueEval[] valueEvalArr, int i, int i2) {
                return Na.evaluate(valueEvalArr, i, i2);
            }
        };
        retval[11] = new Npv();
        ...
        retval[74] = new Function() { // from class: org.apache.poi.ss.formula.eval.FunctionEval$$ExternalSyntheticLambda3
            @Override // org.apache.poi.ss.formula.functions.Function
            public final ValueEval evaluate(ValueEval[] valueEvalArr, int i, int i2) {
                return Now.evaluate(valueEvalArr, i, i2);
            }
        };
        retval[75] = new Areas();
        retval[76] = new Rows();
        ...
        retval[221] = new Function() { // from class: org.apache.poi.ss.formula.eval.FunctionEval$$ExternalSyntheticLambda4
            @Override // org.apache.poi.ss.formula.functions.Function
            public final ValueEval evaluate(ValueEval[] valueEvalArr, int i, int i2) {
                return Today.evaluate(valueEvalArr, i, i2);
            }
        };
        ...
        for (int i = 0; i < retval.length; i++) {
            Function f = retval[i];
            if (f == null && (fm = FunctionMetadataRegistry.getFunctionByIndex(i)) != null) {
