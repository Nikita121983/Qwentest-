...
public final class Sumx2my2 extends XYNumericFunction {
    private static final XYNumericFunction.Accumulator XSquaredMinusYSquaredAccumulator = new XYNumericFunction.Accumulator() { // from class: org.apache.poi.ss.formula.functions.Sumx2my2$$ExternalSyntheticLambda0
        ...
        public final double accumulate(double d, double d2) {
            return Sumx2my2.lambda$static$0(d, d2);
        }
    };
