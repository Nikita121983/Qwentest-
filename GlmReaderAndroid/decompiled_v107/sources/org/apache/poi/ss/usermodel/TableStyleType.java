...
public enum TableStyleType {
    ...
    public CellRangeAddressBase appliesTo(Table table, CellReference cell) {
        ...
        if (table == null || cell == null || !cell.getSheetName().equals(table.getSheetName()) || !table.contains(cell) || (range = getRange(table, cell)) == null || !range.isInRange(cell.getRow(), cell.getCol())) {
            return null;
        }
        return range;
    }
