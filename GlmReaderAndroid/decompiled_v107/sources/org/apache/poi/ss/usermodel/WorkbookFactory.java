...
public final class WorkbookFactory {
    ...
    private WorkbookFactory() {
        ...
        ServiceLoader load = ServiceLoader.load(WorkbookProvider.class, cl);
        final List<WorkbookProvider> list = this.provider;
        list.getClass();
        load.forEach(new Consumer() { // from class: org.apache.poi.ss.usermodel.WorkbookFactory$$ExternalSyntheticLambda2
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                list.add((WorkbookProvider) obj);
            }
        });
    }

    public static Workbook create(boolean xssf) throws IOException {
        return wp(xssf ? FileMagic.OOXML : FileMagic.OLE2, new ProviderMethod() { // from class: org.apache.poi.ss.usermodel.WorkbookFactory$$ExternalSyntheticLambda4
    ...
    public static Workbook create(final DirectoryNode root, final String password) throws IOException {
        if (root.hasEntryCaseInsensitive(Decryptor.DEFAULT_POIFS_ENTRY) || root.hasEntryCaseInsensitive(ExtractorFactory.OOXML_PACKAGE)) {
            return wp(FileMagic.OOXML, new ProviderMethod() { // from class: org.apache.poi.ss.usermodel.WorkbookFactory$$ExternalSyntheticLambda5
                @Override // org.apache.poi.ss.usermodel.WorkbookFactory.ProviderMethod
                public final Workbook create(WorkbookProvider workbookProvider) {
                    Workbook create;
                    create = workbookProvider.create(DirectoryNode.this, password);
                    return create;
                }
            });
        }
        return wp(FileMagic.OLE2, new ProviderMethod() { // from class: org.apache.poi.ss.usermodel.WorkbookFactory$$ExternalSyntheticLambda6
            @Override // org.apache.poi.ss.usermodel.WorkbookFactory.ProviderMethod
            public final Workbook create(WorkbookProvider workbookProvider) {
                Workbook create;
                create = workbookProvider.create(DirectoryNode.this, password);
    ...
    public static Workbook create(InputStream inp, final String password) throws IOException, EncryptedDocumentException {
        ...
        if (FileMagic.OOXML == fm) {
            return wp(fm, new ProviderMethod() { // from class: org.apache.poi.ss.usermodel.WorkbookFactory$$ExternalSyntheticLambda7
                @Override // org.apache.poi.ss.usermodel.WorkbookFactory.ProviderMethod
                public final Workbook create(WorkbookProvider workbookProvider) {
                    Workbook create;
                    create = workbookProvider.create(is);
                    return create;
                }
            });
        }
        ...
        return wp(isOOXML ? FileMagic.OOXML : fm, new ProviderMethod() { // from class: org.apache.poi.ss.usermodel.WorkbookFactory$$ExternalSyntheticLambda8
            @Override // org.apache.poi.ss.usermodel.WorkbookFactory.ProviderMethod
            public final Workbook create(WorkbookProvider workbookProvider) {
                Workbook create;
                create = workbookProvider.create(DirectoryNode.this, password);
    ...
    public static Workbook create(final File file, final String password, final boolean readOnly) throws IOException, EncryptedDocumentException {
        ...
        if (fm == FileMagic.OOXML) {
            return wp(fm, new ProviderMethod() { // from class: org.apache.poi.ss.usermodel.WorkbookFactory$$ExternalSyntheticLambda0
                @Override // org.apache.poi.ss.usermodel.WorkbookFactory.ProviderMethod
                public final Workbook create(WorkbookProvider workbookProvider) {
                    Workbook create;
                    create = workbookProvider.create(file, password, readOnly);
                    return create;
                }
            });
        }
        if (fm == FileMagic.OLE2) {
            ...
            try {
                ...
                fs.close();
                return wp(ooxmlEnc ? FileMagic.OOXML : fm, new ProviderMethod() { // from class: org.apache.poi.ss.usermodel.WorkbookFactory$$ExternalSyntheticLambda1
                    @Override // org.apache.poi.ss.usermodel.WorkbookFactory.ProviderMethod
                    public final Workbook create(WorkbookProvider workbookProvider) {
                        Workbook create;
                        create = workbookProvider.create(file, password, readOnly);
    ...
    private static Workbook wp(FileMagic fm, ProviderMethod fun) throws IOException {
        ...
        throw new IOException("Your InputStream was neither an OLE2 stream, nor an OOXML stream or you haven't provide the poi-ooxml*.jar in the classpath/modulepath - FileMagic: " + fm + ", having providers: " + Singleton.INSTANCE.provider);
    }
    ...
    public static void removeProvider(final Class<? extends WorkbookProvider> provider) {
        Singleton.INSTANCE.provider.removeIf(new Predicate() { // from class: org.apache.poi.ss.usermodel.WorkbookFactory$$ExternalSyntheticLambda3
            ...
            public final boolean test(Object obj) {
                ...
                isAssignableFrom = ((WorkbookProvider) obj).getClass().isAssignableFrom(provider);
