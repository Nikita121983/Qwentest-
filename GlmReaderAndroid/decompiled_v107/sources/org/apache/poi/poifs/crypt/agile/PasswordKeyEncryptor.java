...
public class PasswordKeyEncryptor {
    ...
    public PasswordKeyEncryptor(Element passwordKey) {
        ...
        this.cipherAlgorithm = CipherAlgorithm.fromXmlId(passwordKey.getAttribute("cipherAlgorithm"), this.keyBits == null ? -1 : this.keyBits.intValue());
    ...
    public void write(Element encryption) {
        ...
        EncryptionDocument.setAttr(encryptedKey, "hashAlgorithm", this.hashAlgorithm != null ? this.hashAlgorithm.ecmaString : null);
