...
public class StandardDecryptor extends Decryptor {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public static SecretKey generateSecretKey(String password, EncryptionVerifier ver, int keySize) {
        ...
        byte[] x1 = fillAndXor(finalHash, TarConstants.LF_FIFO);
    ...
    public InputStream getDataStream(DirectoryNode dir) throws IOException {
        ...
        InputStream boundedDis = ((BoundedInputStream.Builder) ((BoundedInputStream.Builder) BoundedInputStream.builder().setInputStream(dis)).setMaxCount(cipherLen)).get();
        return ((BoundedInputStream.Builder) ((BoundedInputStream.Builder) BoundedInputStream.builder().setInputStream(new CipherInputStream(boundedDis, cipher))).setMaxCount(this._length)).get();
    }
