...
public class AgileEncryptor extends Encryptor {
    ...
    protected AgileEncryptor(AgileEncryptor other) {
        ...
        this.pwHash = other.pwHash != null ? (byte[]) other.pwHash.clone() : null;
    }
    ...
    protected void updateIntegrityHMAC(File tmpFile, int oleStreamSize) throws GeneralSecurityException, IOException {
        ...
        InputStream fis = Files.newInputStream(tmpFile.toPath(), new OpenOption[0]);
        while (true) {
            try {
    ...
    protected EncryptionDocument createEncryptionDocument() {
        ...
        keyPass.setSpinCount(Integer.valueOf(ver.getSpinCount()));
        keyData.setSaltSize(Integer.valueOf(header.getBlockSize()));
        keyPass.setSaltSize(Integer.valueOf(ver.getBlockSize()));
        keyData.setBlockSize(Integer.valueOf(header.getBlockSize()));
        keyPass.setBlockSize(Integer.valueOf(ver.getBlockSize()));
        keyData.setKeyBits(Integer.valueOf(header.getKeySize()));
        keyPass.setKeyBits(Integer.valueOf(ver.getKeySize()));
        keyData.setHashSize(Integer.valueOf(header.getHashAlgorithm().hashSize));
        keyPass.setHashSize(Integer.valueOf(ver.getHashAlgorithm().hashSize));
    ...
    public class AgileCipherOutputStream extends ChunkedCipherOutputStream {
        ...
        protected void createEncryptionInfoEntry(DirectoryNode dir, File tmpFile) throws IOException {
            ...
            DataSpaceMapUtils.createEncryptionEntry(dir, EncryptionInfo.ENCRYPTION_INFO_ENTRY, new EncryptionRecord() { // from class: org.apache.poi.poifs.crypt.agile.AgileEncryptor$AgileCipherOutputStream$$ExternalSyntheticLambda0
                @Override // org.apache.poi.poifs.crypt.standard.EncryptionRecord
                public final void write(LittleEndianByteArrayOutputStream littleEndianByteArrayOutputStream) {
                    AgileEncryptor.AgileCipherOutputStream.this.marshallEncryptionRecord(littleEndianByteArrayOutputStream);
                }
            });
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void marshallEncryptionRecord(LittleEndianByteArrayOutputStream bos) {
