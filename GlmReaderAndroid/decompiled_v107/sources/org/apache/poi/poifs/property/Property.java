...
public abstract class Property implements Child, POIFSViewable {
    ...
    public Object[] getViewableArray() {
        ...
        Object[] results = {"Name          = \"" + getName() + "\"", "Property Type = " + ((int) this._property_type.get()), "Node Color    = " + ((int) this._node_color.get()), "Time 1        = " + time2, "Time 2        = " + ((time3 << 32) + (this._seconds_2.get() & 65535)), "Size          = " + getSize()};
        return results;
    }
