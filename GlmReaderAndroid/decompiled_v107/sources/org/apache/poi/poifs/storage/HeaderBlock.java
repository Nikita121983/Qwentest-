...
public final class HeaderBlock implements HeaderBlockConstants {
    ...
    private HeaderBlock(byte[] data) throws IOException {
        ...
        switch (fm) {
            case OLE2:
                ...
                this._property_count = new IntegerField(40, this._data).get();
    ...
    public int getPropertyCount() {
        return this._property_count;
    }

    public void setPropertyCount(int property_count) {
    ...
    public void writeData(OutputStream stream) throws IOException {
        ...
        new IntegerField(40, this.bigBlockSize.getBigBlockSize() == 512 ? 0 : this._property_count, this._data);
