...
public class XDDFHyperlink {
    ...
    @Internal
    public XDDFHyperlink(CTHyperlink link) {
        this.link = link;
    }
    ...
    public void setEndSound(Boolean ends) {
        ...
        this.link.setEndSnd(ends.booleanValue());
    }
    ...
    public void setHighlightClick(Boolean highlights) {
        ...
        this.link.setHighlightClick(highlights.booleanValue());
    }
    ...
    public void setHistory(Boolean history) {
        ...
        this.link.setHistory(history.booleanValue());
    }
