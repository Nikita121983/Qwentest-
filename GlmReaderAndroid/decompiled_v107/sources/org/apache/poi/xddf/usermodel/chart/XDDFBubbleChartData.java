...
public class XDDFBubbleChartData extends XDDFChartData {
    ...
    public XDDFBubbleChartData(XDDFChart parent, CTBubbleChart chart, XDDFChartAxis category, XDDFValueAxis values) {
        super(parent);
        this.chart = chart;
        Map<Long, XDDFChartAxis> categories = Collections.singletonMap(Long.valueOf(category.getId()), category);
        Map<Long, XDDFValueAxis> mapValues = Collections.singletonMap(Long.valueOf(values.getId()), values);
