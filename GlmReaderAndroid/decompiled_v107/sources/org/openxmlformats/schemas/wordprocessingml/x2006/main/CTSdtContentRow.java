...
public interface CTSdtContentRow extends XmlObject {
    public static final DocumentFactory<CTSdtContentRow> Factory = new DocumentFactory<>(TypeSystemHolder.typeSystem, "ctsdtcontentrow740etype");
