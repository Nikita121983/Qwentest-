...
public class CTLockImpl extends XmlComplexContentImpl implements CTLock {
    ...
    public STLock.Enum getVal() {
        ...
        synchronized (monitor()) {
            ...
            r1 = target == null ? null : (STLock.Enum) target.getEnumValue();
        }
        return r1;
    }
    ...
    public STLock xgetVal() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            target = (STLock) get_store().find_attribute_user(PROPERTY_QNAME[0]);
        }
        return target;
    }
    ...
    public void xsetVal(STLock val) {
        synchronized (monitor()) {
            check_orphaned();
            STLock target = (STLock) get_store().find_attribute_user(PROPERTY_QNAME[0]);
            if (target == null) {
                target = (STLock) get_store().add_attribute_user(PROPERTY_QNAME[0]);
            }
            target.set(val);
        }
    }
