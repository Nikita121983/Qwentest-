...
public class CTSdtDateMappingTypeImpl extends XmlComplexContentImpl implements CTSdtDateMappingType {
    ...
    public STSdtDateMappingType.Enum getVal() {
        STSdtDateMappingType.Enum r1;
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue target = (SimpleValue) get_store().find_attribute_user(PROPERTY_QNAME[0]);
            r1 = target == null ? null : (STSdtDateMappingType.Enum) target.getEnumValue();
        }
        return r1;
    }
    ...
    public STSdtDateMappingType xgetVal() {
        STSdtDateMappingType target;
        synchronized (monitor()) {
            check_orphaned();
            target = (STSdtDateMappingType) get_store().find_attribute_user(PROPERTY_QNAME[0]);
        }
        return target;
    }
    ...
    public void xsetVal(STSdtDateMappingType val) {
        synchronized (monitor()) {
            check_orphaned();
            STSdtDateMappingType target = (STSdtDateMappingType) get_store().find_attribute_user(PROPERTY_QNAME[0]);
            if (target == null) {
                target = (STSdtDateMappingType) get_store().add_attribute_user(PROPERTY_QNAME[0]);
            }
            target.set(val);
        }
    }
