...
public class CTMCImpl extends XmlComplexContentImpl implements CTMC {
    ...
    public CTMCPr getMcPr() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            CTMCPr target = (CTMCPr) get_store().find_element_user(PROPERTY_QNAME[0], 0);
            cTMCPr = target == null ? null : target;
        }
        return cTMCPr;
    }
    ...
    public void setMcPr(CTMCPr mcPr) {
        generatedSetterHelperImpl(mcPr, PROPERTY_QNAME[0], 0, (short) 1);
    }
    ...
    public CTMCPr addNewMcPr() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            target = (CTMCPr) get_store().add_element_user(PROPERTY_QNAME[0]);
        }
        return target;
    }
