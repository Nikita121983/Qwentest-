...
public final class STTLTimeNodeMasterRelation$Enum extends StringEnumAbstractBase {
    ...
    public static STTLTimeNodeMasterRelation$Enum forString(String s) {
        return (STTLTimeNodeMasterRelation$Enum) table.forString(s);
    }
    ...
    private STTLTimeNodeMasterRelation$Enum(String s, int i) {
        super(s, i);
    }
