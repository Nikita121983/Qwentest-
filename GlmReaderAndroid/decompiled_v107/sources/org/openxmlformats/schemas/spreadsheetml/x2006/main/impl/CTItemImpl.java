...
public class CTItemImpl extends XmlComplexContentImpl implements CTItem {
    ...
    public STItemType.Enum getT() {
        ...
        synchronized (monitor()) {
            ...
            r1 = target == null ? null : (STItemType.Enum) target.getEnumValue();
        }
        return r1;
    }
    ...
    public STItemType xgetT() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            target = (STItemType) get_store().find_attribute_user(PROPERTY_QNAME[1]);
            if (target == null) {
                target = (STItemType) get_default_attribute_value(PROPERTY_QNAME[1]);
            }
        }
        return target;
    }
    ...
    public void xsetT(STItemType t) {
        synchronized (monitor()) {
            check_orphaned();
            STItemType target = (STItemType) get_store().find_attribute_user(PROPERTY_QNAME[1]);
            if (target == null) {
                target = (STItemType) get_store().add_attribute_user(PROPERTY_QNAME[1]);
            }
            target.set(t);
        }
    }
