...
public final class STDataValidationImeMode$Enum extends StringEnumAbstractBase {
    ...
    public static STDataValidationImeMode$Enum forString(String s) {
        return (STDataValidationImeMode$Enum) table.forString(s);
    }
    ...
    private STDataValidationImeMode$Enum(String s, int i) {
        super(s, i);
    }
