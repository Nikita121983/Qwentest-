...
public final class STPhoneticAlignment$Enum extends StringEnumAbstractBase {
    ...
    public static STPhoneticAlignment$Enum forString(String s) {
        return (STPhoneticAlignment$Enum) table.forString(s);
    }
    ...
    private STPhoneticAlignment$Enum(String s, int i) {
        super(s, i);
    }
