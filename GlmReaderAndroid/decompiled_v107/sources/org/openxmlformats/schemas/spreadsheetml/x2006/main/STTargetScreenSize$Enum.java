...
public final class STTargetScreenSize$Enum extends StringEnumAbstractBase {
    ...
    public static STTargetScreenSize$Enum forString(String s) {
        return (STTargetScreenSize$Enum) table.forString(s);
    }
    ...
    private STTargetScreenSize$Enum(String s, int i) {
        super(s, i);
    }
