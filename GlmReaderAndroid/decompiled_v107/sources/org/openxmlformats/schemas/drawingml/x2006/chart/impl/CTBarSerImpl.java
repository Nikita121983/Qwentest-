...
public class CTBarSerImpl extends XmlComplexContentImpl implements CTBarSer {
    ...
    public CTPictureOptions getPictureOptions() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            CTPictureOptions target = get_store().find_element_user(PROPERTY_QNAME[5], 0);
    ...
    public void setPictureOptions(CTPictureOptions pictureOptions) {
        generatedSetterHelperImpl(pictureOptions, PROPERTY_QNAME[5], 0, (short) 1);
    }
    ...
    public List<CTDPt> getDPtList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new Function() { // from class: org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTBarSerImpl$$ExternalSyntheticLambda0
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                    return CTBarSerImpl.this.getDPtArray(((Integer) obj).intValue());
                }
            }, new BiConsumer() { // from class: org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTBarSerImpl$$ExternalSyntheticLambda1
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
                    CTBarSerImpl.this.setDPtArray(((Integer) obj).intValue(), (CTDPt) obj2);
                }
            }, new Function() { // from class: org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTBarSerImpl$$ExternalSyntheticLambda2
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                    return CTBarSerImpl.this.insertNewDPt(((Integer) obj).intValue());
                }
            }, new Consumer() { // from class: org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTBarSerImpl$$ExternalSyntheticLambda3
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    CTBarSerImpl.this.removeDPt(((Integer) obj).intValue());
                }
            }, new Supplier() { // from class: org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTBarSerImpl$$ExternalSyntheticLambda4
                @Override // java.util.function.Supplier
                public final Object get() {
                    return Integer.valueOf(CTBarSerImpl.this.sizeOfDPtArray());
                }
            });
        }
    ...
    public CTDPt getDPtArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            target = (CTDPt) get_store().find_element_user(PROPERTY_QNAME[6], i);
            if (target == null) {
    ...
    public void setDPtArray(int i, CTDPt dPt) {
        generatedSetterHelperImpl(dPt, PROPERTY_QNAME[6], i, (short) 2);
    }
    ...
    public CTDPt insertNewDPt(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            target = (CTDPt) get_store().insert_element_user(PROPERTY_QNAME[6], i);
        }
        return target;
    }
    ...
    public CTDPt addNewDPt() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            target = (CTDPt) get_store().add_element_user(PROPERTY_QNAME[6]);
        }
        return target;
    }
    ...
    public CTDLbls getDLbls() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            CTDLbls target = (CTDLbls) get_store().find_element_user(PROPERTY_QNAME[7], 0);
    ...
    public void setDLbls(CTDLbls dLbls) {
        generatedSetterHelperImpl(dLbls, PROPERTY_QNAME[7], 0, (short) 1);
    }
    ...
    public CTDLbls addNewDLbls() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            target = (CTDLbls) get_store().add_element_user(PROPERTY_QNAME[7]);
        }
        return target;
    }
    ...
    public List<CTTrendline> getTrendlineList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new Function() { // from class: org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTBarSerImpl$$ExternalSyntheticLambda5
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                    return CTBarSerImpl.this.getTrendlineArray(((Integer) obj).intValue());
                }
            }, new BiConsumer() { // from class: org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTBarSerImpl$$ExternalSyntheticLambda6
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
                    CTBarSerImpl.this.setTrendlineArray(((Integer) obj).intValue(), (CTTrendline) obj2);
                }
            }, new Function() { // from class: org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTBarSerImpl$$ExternalSyntheticLambda7
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                    return CTBarSerImpl.this.insertNewTrendline(((Integer) obj).intValue());
                }
            }, new Consumer() { // from class: org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTBarSerImpl$$ExternalSyntheticLambda8
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    CTBarSerImpl.this.removeTrendline(((Integer) obj).intValue());
                }
            }, new Supplier() { // from class: org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTBarSerImpl$$ExternalSyntheticLambda9
                @Override // java.util.function.Supplier
                public final Object get() {
                    return Integer.valueOf(CTBarSerImpl.this.sizeOfTrendlineArray());
                }
            });
        }
        return javaListXmlObject;
    ...
    public void setTrendlineArray(CTTrendline[] trendlineArray) {
        check_orphaned();
        arraySetterHelper((XmlObject[]) trendlineArray, PROPERTY_QNAME[8]);
    }

    @Override // org.openxmlformats.schemas.drawingml.x2006.chart.CTBarSer
    public void setTrendlineArray(int i, CTTrendline trendline) {
        generatedSetterHelperImpl(trendline, PROPERTY_QNAME[8], i, (short) 2);
    }
    ...
    public CTErrBars getErrBars() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            CTErrBars target = (CTErrBars) get_store().find_element_user(PROPERTY_QNAME[9], 0);
    ...
    public void setErrBars(CTErrBars errBars) {
        generatedSetterHelperImpl(errBars, PROPERTY_QNAME[9], 0, (short) 1);
    }
    ...
    public CTErrBars addNewErrBars() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            target = (CTErrBars) get_store().add_element_user(PROPERTY_QNAME[9]);
        }
        return target;
    }
    ...
    public CTAxDataSource getCat() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            CTAxDataSource target = (CTAxDataSource) get_store().find_element_user(PROPERTY_QNAME[10], 0);
    ...
    public void setCat(CTAxDataSource cat) {
        generatedSetterHelperImpl(cat, PROPERTY_QNAME[10], 0, (short) 1);
    }
    ...
    public CTAxDataSource addNewCat() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            target = (CTAxDataSource) get_store().add_element_user(PROPERTY_QNAME[10]);
        }
        return target;
    }
    ...
    public void setVal(CTNumDataSource val) {
        generatedSetterHelperImpl(val, PROPERTY_QNAME[11], 0, (short) 1);
    }
    ...
    public CTShape getShape() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            CTShape target = (CTShape) get_store().find_element_user(PROPERTY_QNAME[12], 0);
    ...
    public void setShape(CTShape shape) {
        generatedSetterHelperImpl(shape, PROPERTY_QNAME[12], 0, (short) 1);
    }
    ...
    public CTShape addNewShape() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            target = (CTShape) get_store().add_element_user(PROPERTY_QNAME[12]);
        }
        return target;
    }
