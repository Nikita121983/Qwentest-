...
public interface STBlipCompression extends XmlToken {
    ...
    public static final Enum EMAIL = Enum.forString(NotificationCompat.CATEGORY_EMAIL);
    ...
    public static final class Enum extends StringEnumAbstractBase {
        ...
        public static final StringEnumAbstractBase.Table table = new StringEnumAbstractBase.Table(new Enum[]{new Enum(NotificationCompat.CATEGORY_EMAIL, 1), new Enum("screen", 2), new Enum("print", 3), new Enum("hqprint", 4), new Enum("none", 5)});
