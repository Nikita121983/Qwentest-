...
public class CTFontReferenceImpl extends XmlComplexContentImpl implements CTFontReference {
    ...
    public STFontCollectionIndex.Enum getIdx() {
        STFontCollectionIndex.Enum r1;
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue target = (SimpleValue) get_store().find_attribute_user(PROPERTY_QNAME[6]);
            r1 = target == null ? null : (STFontCollectionIndex.Enum) target.getEnumValue();
        }
        return r1;
    }
    ...
    public STFontCollectionIndex xgetIdx() {
        STFontCollectionIndex target;
        synchronized (monitor()) {
            check_orphaned();
            target = (STFontCollectionIndex) get_store().find_attribute_user(PROPERTY_QNAME[6]);
        }
        return target;
    }
    ...
    public void xsetIdx(STFontCollectionIndex idx) {
        synchronized (monitor()) {
            check_orphaned();
            STFontCollectionIndex target = (STFontCollectionIndex) get_store().find_attribute_user(PROPERTY_QNAME[6]);
            if (target == null) {
                target = (STFontCollectionIndex) get_store().add_attribute_user(PROPERTY_QNAME[6]);
            }
            target.set(idx);
        }
    }
