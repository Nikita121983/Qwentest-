...
public class CTLayoutImpl extends XmlComplexContentImpl implements CTLayout {
    ...
    public CTManualLayout getManualLayout() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            CTManualLayout target = (CTManualLayout) get_store().find_element_user(PROPERTY_QNAME[0], 0);
            cTManualLayout = target == null ? null : target;
        }
    ...
    public void setManualLayout(CTManualLayout manualLayout) {
        generatedSetterHelperImpl(manualLayout, PROPERTY_QNAME[0], 0, (short) 1);
    }

    @Override // org.openxmlformats.schemas.drawingml.x2006.chart.CTLayout
    public CTManualLayout addNewManualLayout() {
        CTManualLayout target;
        synchronized (monitor()) {
            check_orphaned();
            target = (CTManualLayout) get_store().add_element_user(PROPERTY_QNAME[0]);
        }
        return target;
    }
