...
public class CTValAxImpl extends XmlComplexContentImpl implements CTValAx {
    ...
    public CTCrossBetween getCrossBetween() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            CTCrossBetween target = (CTCrossBetween) get_store().find_element_user(PROPERTY_QNAME[16], 0);
            cTCrossBetween = target == null ? null : target;
        }
    ...
    public void setCrossBetween(CTCrossBetween crossBetween) {
        generatedSetterHelperImpl(crossBetween, PROPERTY_QNAME[16], 0, (short) 1);
    }

    @Override // org.openxmlformats.schemas.drawingml.x2006.chart.CTValAx
    public CTCrossBetween addNewCrossBetween() {
        CTCrossBetween target;
        synchronized (monitor()) {
            check_orphaned();
            target = (CTCrossBetween) get_store().add_element_user(PROPERTY_QNAME[16]);
        }
        return target;
    }
    ...
    public CTAxisUnit getMajorUnit() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            CTAxisUnit target = (CTAxisUnit) get_store().find_element_user(PROPERTY_QNAME[17], 0);
    ...
    public void setMajorUnit(CTAxisUnit majorUnit) {
        generatedSetterHelperImpl(majorUnit, PROPERTY_QNAME[17], 0, (short) 1);
    }
    ...
    public CTAxisUnit addNewMajorUnit() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            target = (CTAxisUnit) get_store().add_element_user(PROPERTY_QNAME[17]);
        }
        return target;
    }
    ...
    public CTAxisUnit getMinorUnit() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            CTAxisUnit target = (CTAxisUnit) get_store().find_element_user(PROPERTY_QNAME[18], 0);
            cTAxisUnit = target == null ? null : target;
        }
        return cTAxisUnit;
    }
    ...
    public void setMinorUnit(CTAxisUnit minorUnit) {
        generatedSetterHelperImpl(minorUnit, PROPERTY_QNAME[18], 0, (short) 1);
    }
    ...
    public CTAxisUnit addNewMinorUnit() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            target = (CTAxisUnit) get_store().add_element_user(PROPERTY_QNAME[18]);
        }
        return target;
    }
    ...
    public CTDispUnits getDispUnits() {
        CTDispUnits cTDispUnits;
        synchronized (monitor()) {
            check_orphaned();
            CTDispUnits target = get_store().find_element_user(PROPERTY_QNAME[19], 0);
            cTDispUnits = target == null ? null : target;
        }
        return cTDispUnits;
    }
    ...
    public void setDispUnits(CTDispUnits dispUnits) {
        generatedSetterHelperImpl(dispUnits, PROPERTY_QNAME[19], 0, (short) 1);
    }
    ...
    public CTExtensionList getExtLst() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            CTExtensionList target = (CTExtensionList) get_store().find_element_user(PROPERTY_QNAME[20], 0);
    ...
    public void setExtLst(CTExtensionList extLst) {
        generatedSetterHelperImpl(extLst, PROPERTY_QNAME[20], 0, (short) 1);
    }
    ...
    public CTExtensionList addNewExtLst() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            target = (CTExtensionList) get_store().add_element_user(PROPERTY_QNAME[20]);
        }
        return target;
    }
