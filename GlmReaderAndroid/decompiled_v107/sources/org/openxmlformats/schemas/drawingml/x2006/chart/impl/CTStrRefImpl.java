...
public class CTStrRefImpl extends XmlComplexContentImpl implements CTStrRef {
    ...
    public CTStrData getStrCache() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            CTStrData target = (CTStrData) get_store().find_element_user(PROPERTY_QNAME[1], 0);
    ...
    public void setStrCache(CTStrData strCache) {
        generatedSetterHelperImpl(strCache, PROPERTY_QNAME[1], 0, (short) 1);
    }
    ...
    public CTStrData addNewStrCache() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            target = (CTStrData) get_store().add_element_user(PROPERTY_QNAME[1]);
        }
        return target;
    }
