...
public final class STPresetMaterialType$Enum extends StringEnumAbstractBase {
    ...
    public static STPresetMaterialType$Enum forString(String s) {
        return (STPresetMaterialType$Enum) table.forString(s);
    }
    ...
    private STPresetMaterialType$Enum(String s, int i) {
        super(s, i);
    }
