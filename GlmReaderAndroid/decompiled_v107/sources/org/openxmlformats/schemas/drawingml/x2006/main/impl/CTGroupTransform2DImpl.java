...
public class CTGroupTransform2DImpl extends XmlComplexContentImpl implements CTGroupTransform2D {
    ...
    public CTPoint2D getChOff() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            CTPoint2D target = (CTPoint2D) get_store().find_element_user(PROPERTY_QNAME[2], 0);
            cTPoint2D = target == null ? null : target;
        }
        return cTPoint2D;
    }
    ...
    public void setChOff(CTPoint2D chOff) {
        generatedSetterHelperImpl(chOff, PROPERTY_QNAME[2], 0, (short) 1);
    }
    ...
    public CTPoint2D addNewChOff() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            target = (CTPoint2D) get_store().add_element_user(PROPERTY_QNAME[2]);
        }
        return target;
    }
    ...
    public void setChExt(CTPositiveSize2D chExt) {
        generatedSetterHelperImpl(chExt, PROPERTY_QNAME[3], 0, (short) 1);
    }
    ...
    public STAngle xgetRot() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            target = (STAngle) get_store().find_attribute_user(PROPERTY_QNAME[4]);
            if (target == null) {
                target = (STAngle) get_default_attribute_value(PROPERTY_QNAME[4]);
            }
        }
        return target;
    }
    ...
    public void xsetRot(STAngle rot) {
        synchronized (monitor()) {
            check_orphaned();
            STAngle target = (STAngle) get_store().find_attribute_user(PROPERTY_QNAME[4]);
            if (target == null) {
                target = (STAngle) get_store().add_attribute_user(PROPERTY_QNAME[4]);
            }
            target.set(rot);
        }
    }
