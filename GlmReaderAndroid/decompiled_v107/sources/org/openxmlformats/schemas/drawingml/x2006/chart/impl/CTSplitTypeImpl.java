...
public class CTSplitTypeImpl extends XmlComplexContentImpl implements CTSplitType {
    ...
    public STSplitType.Enum getVal() {
        ...
        synchronized (monitor()) {
            ...
            r1 = target == null ? null : (STSplitType.Enum) target.getEnumValue();
        }
        return r1;
    }
    ...
    public STSplitType xgetVal() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            target = (STSplitType) get_store().find_attribute_user(PROPERTY_QNAME[0]);
            if (target == null) {
                target = (STSplitType) get_default_attribute_value(PROPERTY_QNAME[0]);
            }
        }
        return target;
    }
    ...
    public void xsetVal(STSplitType val) {
        synchronized (monitor()) {
            check_orphaned();
            STSplitType target = (STSplitType) get_store().find_attribute_user(PROPERTY_QNAME[0]);
            if (target == null) {
                target = (STSplitType) get_store().add_attribute_user(PROPERTY_QNAME[0]);
            }
            target.set(val);
        }
    }
