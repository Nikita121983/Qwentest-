...
public class CTStyleMatrixReferenceImpl extends XmlComplexContentImpl implements CTStyleMatrixReference {
    ...
    public STStyleMatrixColumnIndex xgetIdx() {
        STStyleMatrixColumnIndex target;
        synchronized (monitor()) {
            check_orphaned();
            target = (STStyleMatrixColumnIndex) get_store().find_attribute_user(PROPERTY_QNAME[6]);
        }
        return target;
    }
    ...
    public void xsetIdx(STStyleMatrixColumnIndex idx) {
        synchronized (monitor()) {
            check_orphaned();
            STStyleMatrixColumnIndex target = (STStyleMatrixColumnIndex) get_store().find_attribute_user(PROPERTY_QNAME[6]);
            if (target == null) {
                target = (STStyleMatrixColumnIndex) get_store().add_attribute_user(PROPERTY_QNAME[6]);
            }
            target.set(idx);
        }
    }
