...
public class UuidKt__UuidKt extends UuidKt__UuidJVMKt {
    public static final Uuid uuidFromRandomBytes(byte[] randomBytes) {
        ...
        randomBytes[6] = (byte) (randomBytes[6] & IntersectionPtg.sid);
        randomBytes[6] = (byte) (randomBytes[6] | Ptg.CLASS_ARRAY);
    ...
    public static final void checkHyphenAt(String $this$checkHyphenAt, int index) {
        ...
        if (!($this$checkHyphenAt.charAt(index) == '-')) {
            throw new IllegalArgumentException(("Expected '-' (hyphen) at index " + index + ", but was '" + $this$checkHyphenAt.charAt(index) + Chars.QUOTE).toString());
        }
    }
    ...
    public static final String truncateForErrorMessage$UuidKt__UuidKt(byte[] $this$truncateForErrorMessage, int maxSize) {
        return ArraysKt.joinToString$default($this$truncateForErrorMessage, (CharSequence) null, (CharSequence) CollectionUtils.DEFAULT_TOSTRING_PREFIX, (CharSequence) CollectionUtils.DEFAULT_TOSTRING_SUFFIX, maxSize, (CharSequence) null, (Function1) null, 49, (Object) null);
    }
}
