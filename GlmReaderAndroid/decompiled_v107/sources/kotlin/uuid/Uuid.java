...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m564boximpl(ULong.m570constructorimpl(getMostSignificantBits())), ULong.m564boximpl(ULong.m570constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m1880toUByteArrayTcUX1vc() {
        return UByteArray.m467constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (this.mostSignificantBits != other.mostSignificantBits) {
            return Long.compareUnsigned(ULong.m570constructorimpl(this.mostSignificantBits), ULong.m570constructorimpl(other.mostSignificantBits));
        }
        return Long.compareUnsigned(ULong.m570constructorimpl(this.leastSignificantBits), ULong.m570constructorimpl(other.leastSignificantBits));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m1882fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m1881fromUByteArrayGBYM_sE(byte[] ubyteArray) {
