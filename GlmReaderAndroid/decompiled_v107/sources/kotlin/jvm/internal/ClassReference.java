            ...
            if (jClass.isArray()) {
                ...
                if (componentType.isPrimitive()) {
                    ...
                    if (simpleNameOf != null) {
                        str = simpleNameOf + SoapEncSchemaTypeSystem.SOAP_ARRAY;
                    }
                }
                return str == null ? SoapEncSchemaTypeSystem.SOAP_ARRAY : str;
            }
            ...
            if (jClass.isArray()) {
                ...
                if (componentType.isPrimitive()) {
                    ...
                    if (classFqNameOf != null) {
                        str = classFqNameOf + SoapEncSchemaTypeSystem.SOAP_ARRAY;
                    }
                }
