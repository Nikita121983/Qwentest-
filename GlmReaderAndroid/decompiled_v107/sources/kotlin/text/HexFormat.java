...
public final class HexFormat {
    ...
    public String toString() {
        ...
        $this$toString_u24lambda_u240.append("    upperCase = ").append(this.upperCase).append(CollectionUtils.COMMA).append('\n');
    ...
    public static final class BytesHexFormat {
        ...
        */
        ...
        public final StringBuilder appendOptionsTo$kotlin_stdlib(StringBuilder sb, String indent) {
            ...
            sb.append(indent).append("bytesPerLine = ").append(this.bytesPerLine).append(CollectionUtils.COMMA).append('\n');
            sb.append(indent).append("bytesPerGroup = ").append(this.bytesPerGroup).append(CollectionUtils.COMMA).append('\n');
