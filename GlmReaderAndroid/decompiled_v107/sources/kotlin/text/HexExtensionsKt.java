...
public final class HexExtensionsKt {
    ...
    private static final int checkFormatLength(long formatLength) {
        ...
        if (!z) {
            throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m616toStringimpl(ULong.m570constructorimpl(formatLength))));
        }
    ...
    public static final String toHexString(byte $this$toHexString, HexFormat format) {
        ...
        if (numberFormat.getIsDigitsOnlyAndNoPadding()) {
            char[] charArray = {digits.charAt(($this$toHexString >> 4) & 15), digits.charAt($this$toHexString & IntersectionPtg.sid)};
    ...
    private static final void throwInvalidNumberOfDigits(String $this$throwInvalidNumberOfDigits, int startIndex, int endIndex, String specifier, int expected) {
        ...
        throw new NumberFormatException("Expected " + specifier + Chars.SPACE + expected + " hexadecimal digits at index " + startIndex + ", but was \"" + substring + "\" of length " + (endIndex - startIndex));
    }
