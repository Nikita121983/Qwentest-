...
public abstract class AbstractMap<K, V> implements Map<K, V>, KMappedMarker {
    ...
    public String toString() {
        return CollectionsKt.joinToString$default(entrySet(), ", ", VectorFormat.DEFAULT_PREFIX, VectorFormat.DEFAULT_SUFFIX, 0, null, new Function1() { // from class: kotlin.collections.AbstractMap$$ExternalSyntheticLambda0
    ...
    private final String toString(Map.Entry<? extends K, ? extends V> entry) {
        return toString(entry.getKey()) + Chars.EQ + toString(entry.getValue());
    }
    ...
    public static final class Companion {
        ...
        public final String entryToString$kotlin_stdlib(Map.Entry<?, ?> e) {
            Intrinsics.checkNotNullParameter(e, "e");
            return new StringBuilder().append(e.getKey()).append(Chars.EQ).append(e.getValue()).toString();
        }
