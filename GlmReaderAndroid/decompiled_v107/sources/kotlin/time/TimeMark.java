...
public interface TimeMark {
    ...
    TimeMark mo1734minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1736plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1855plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1854minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo1736plusLRDsOJo(Duration.m1787unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1769isNegativeimpl($this.mo1733elapsedNowUwyO8pc());
        }
