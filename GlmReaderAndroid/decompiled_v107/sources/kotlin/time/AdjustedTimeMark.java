...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1734minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m1854minusLRDsOJo(this, duration);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo1733elapsedNowUwyO8pc() {
        return Duration.m1771minusLRDsOJo(this.mark.mo1733elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1736plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1772plusLRDsOJo(this.adjustment, duration), null);
    }
}
