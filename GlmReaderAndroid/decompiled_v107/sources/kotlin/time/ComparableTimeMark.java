...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo1734minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo1735minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo1736plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m1738minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo1736plusLRDsOJo(Duration.m1787unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m1742compareToLRDsOJo($this.mo1735minusUwyO8pc(other), Duration.INSTANCE.m1834getZEROUwyO8pc());
        }
    }
}
