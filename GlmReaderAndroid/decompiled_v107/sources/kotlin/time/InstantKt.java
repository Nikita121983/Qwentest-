...
public final class InstantKt {
    ...
    private static final int[] POWERS_OF_TEN = {1, 10, 100, 1000, 10000, BZip2Constants.BASEBLOCKSIZE, 1000000, PoissonDistribution.DEFAULT_MAX_ITERATIONS, 100000000, NANOS_PER_SECOND};
    ...
    */
    ...
    public static final String formatIso(Instant instant) {
        ...
        $this$formatIso_u24lambda_u2413.append(NameUtil.COLON);
    ...
    public static final boolean isLeapYear(int year) {
        return (year & 3) == 0 && (year % 100 != 0 || year % FontHeader.REGULAR_WEIGHT == 0);
    }
