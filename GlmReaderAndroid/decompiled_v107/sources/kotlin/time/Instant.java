...
public final class Instant implements Comparable<Instant>, Serializable {
    ...
    public final long toEpochMilliseconds() {
        ...
        long b$iv2 = (this.nanosecondsOfSecond / 1000000) + NotificationManagerCompat.IMPORTANCE_UNSPECIFIED;
    ...
    public final Instant m1843plusLRDsOJo(long duration) {
        long secondsToAdd = Duration.m1757getInWholeSecondsimpl(duration);
        int nanosecondsToAdd = Duration.m1759getNanosecondsComponentimpl(duration);
        ...
        if ((a$iv ^ sum$iv) < 0 && (a$iv ^ secondsToAdd) >= 0) {
            return Duration.m1770isPositiveimpl(duration) ? MAX : MIN;
        }
    ...
    public final Instant m1841minusLRDsOJo(long duration) {
        return m1843plusLRDsOJo(Duration.m1787unaryMinusUwyO8pc(duration));
    }

    /* renamed from: minus-UwyO8pc, reason: not valid java name */
    public final long m1842minusUwyO8pc(Instant other) {
        Intrinsics.checkNotNullParameter(other, "other");
        Duration.Companion companion = Duration.INSTANCE;
        long duration = DurationKt.toDuration(this.epochSeconds - other.epochSeconds, DurationUnit.SECONDS);
        Duration.Companion companion2 = Duration.INSTANCE;
        return Duration.m1772plusLRDsOJo(duration, DurationKt.toDuration(this.nanosecondsOfSecond - other.nanosecondsOfSecond, DurationUnit.NANOSECONDS));
    }
