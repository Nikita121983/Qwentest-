...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1857boximpl(m1851markNowz9LOYto());
    }
    ...
    public long m1851markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1860constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m1850elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m1849differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m1848adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1860constructorimpl(LongSaturatedMathKt.m1846saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
