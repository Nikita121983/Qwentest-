...
public final class SparseParcelableArraySerializer implements KSerializer<SparseArray<Parcelable>> {
    ...
    public void serialize(Encoder encoder, SparseArray<Parcelable> value) {
        ...
        Bundle $this$serialize_u24lambda_u242_u24lambda_u241 = SavedStateWriter.m218constructorimpl($this$write$iv);
        SavedStateWriter.m250putSparseParcelableArrayimpl($this$serialize_u24lambda_u242_u24lambda_u241, $this$serialize_u24lambda_u242.getKey(), value);
    }
    ...
    public SparseArray<Parcelable> deserialize(Decoder decoder) {
        ...
        Bundle $this$deserialize_u24lambda_u245_u24lambda_u244 = SavedStateReader.m132constructorimpl($this$read$iv);
        String key$iv = $this$deserialize_u24lambda_u245.getKey();
        return SavedStateReader.m200getSparseParcelableArrayimpl($this$deserialize_u24lambda_u245_u24lambda_u244, key$iv, Reflection.getOrCreateKotlinClass(Parcelable.class));
    }
}
