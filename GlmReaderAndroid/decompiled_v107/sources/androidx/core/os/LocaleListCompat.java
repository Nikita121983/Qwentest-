...
public final class LocaleListCompat {
    ...
    public static LocaleListCompat forLanguageTags(String list) {
        ...
        String[] tags = list.split(CollectionUtils.COMMA, -1);
    ...
    public static Locale forLanguageTagCompat(String str) {
        if (str.contains(ProcessIdUtil.DEFAULT_PROCESSID)) {
            String[] args = str.split(ProcessIdUtil.DEFAULT_PROCESSID, -1);
            if (args.length > 2) {
        ...
        throw new IllegalArgumentException("Can not parse language tag: [" + str + CollectionUtils.DEFAULT_TOSTRING_SUFFIX);
    }
