...
public class ViewCompat {
    ...
    public static ContentInfoCompat performReceiveContent(View view, ContentInfoCompat payload) {
        if (Log.isLoggable(TAG, 3)) {
            Log.d(TAG, "performReceiveContent: " + payload + ", view=" + view.getClass().getSimpleName() + CollectionUtils.DEFAULT_TOSTRING_PREFIX + view.getId() + CollectionUtils.DEFAULT_TOSTRING_SUFFIX);
        }
        if (Build.VERSION.SDK_INT >= 31) {
