...
public class TransitionSet extends Transition {
    ...
    public String toString(String indent) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            result = result + StringUtils.LF + this.mTransitions.get(i).toString(indent + "  ");
        }
        return result;
    }
    ...
    public Transition mo263clone() {
        TransitionSet clone = (TransitionSet) super.mo263clone();
        clone.mTransitions = new ArrayList<>();
        int numTransitions = this.mTransitions.size();
        for (int i = 0; i < numTransitions; i++) {
            clone.addTransitionInternal(this.mTransitions.get(i).mo263clone());
        }
        return clone;
    }
}
