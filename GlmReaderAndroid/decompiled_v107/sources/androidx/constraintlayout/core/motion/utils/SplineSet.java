...
public abstract class SplineSet {
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.mCount; i++) {
            str = str + CollectionUtils.DEFAULT_TOSTRING_PREFIX + this.mTimePoints[i] + " , " + df.format(this.mValues[i]) + "] ";
        }
        return str;
    }
    ...
    public static class CustomSet extends SplineSet {
        ...
        public CustomSet(String attribute, KeyFrameArray.CustomArray attrList) {
            this.mAttributeName = attribute.split(CollectionUtils.COMMA)[1];
