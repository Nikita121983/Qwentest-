...
public class StopLogicEngine implements StopEngine {
    ...
    public String debug(String desc, float time) {
        String ret = ((desc + " ===== " + this.mType + StringUtils.LF) + desc + (this.mBackwards ? "backwards" : "forward ") + " time = " + time + "  stages " + this.mNumberOfStages + StringUtils.LF) + desc + " dur " + this.mStage1Duration + " vel " + this.mStage1Velocity + " pos " + this.mStage1EndPosition + StringUtils.LF;
        if (this.mNumberOfStages > 1) {
            ret = ret + desc + " dur " + this.mStage2Duration + " vel " + this.mStage2Velocity + " pos " + this.mStage2EndPosition + StringUtils.LF;
        }
        if (this.mNumberOfStages > 2) {
            ret = ret + desc + " dur " + this.mStage3Duration + " vel " + this.mStage3Velocity + " pos " + this.mStage3EndPosition + StringUtils.LF;
        }
    ...
    public static class Decelerate implements StopEngine {
        ...
        @Override // androidx.constraintlayout.core.motion.utils.StopEngine
        public String debug(String desc, float time) {
            return this.mDuration + StringUtils.SPACE + this.mLastVelocity;
        }
