...
public class Utils {
    ...
    public static void socketSend(String str) {
        try {
            ...
            System.err.println(e.toString() + StringUtils.LF + Arrays.toString(e.getStackTrace()).replace(CollectionUtils.DEFAULT_TOSTRING_PREFIX, "   at ").replace(CollectionUtils.COMMA, "\n   at").replace(CollectionUtils.DEFAULT_TOSTRING_SUFFIX, ""));
        }
    }
    ...
    public static void log(String str) {
        ...
        System.out.println(ss + StringUtils.SPACE + str);
        if (sOurHandle != null) {
            sOurHandle.message(ss + StringUtils.SPACE + str);
        }
    }
}
