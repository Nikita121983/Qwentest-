...
public class ConstraintSetParser {
        ...
        while (it.hasNext()) {
            ...
            switch (c) {
                ...
                case '\b':
                    ...
                    if (rowWeights == null || !rowWeights.contains(CollectionUtils.COMMA)) {
                        break;
                    } else {
                ...
                case '\t':
                    ...
                    if (columnWeights == null || !columnWeights.contains(CollectionUtils.COMMA)) {
                        break;
                    } else {
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:173:0x0285, code lost:
        ...
        if (r29.equals("top") != false) goto L177;
     */
