...
public class WidgetFrame {
    ...
    void printCustomAttributes() {
        ...
        String ss2 = (".(" + s.getFileName() + ":" + s.getLineNumber() + ") " + s.getMethodName()) + StringUtils.SPACE + (hashCode() % 1000);
        if (this.widget != null) {
            ss = ss2 + PackagingURIHelper.FORWARD_SLASH_STRING + (this.widget.hashCode() % 1000) + StringUtils.SPACE;
        } else {
            ss = ss2 + "/NULL ";
        }
    ...
    void logv(String str) {
        ...
        String ss2 = (".(" + s.getFileName() + ":" + s.getLineNumber() + ") " + s.getMethodName()) + StringUtils.SPACE + (hashCode() % 1000);
        if (this.widget != null) {
            ss = ss2 + PackagingURIHelper.FORWARD_SLASH_STRING + (this.widget.hashCode() % 1000);
        } else {
            ss = ss2 + "/NULL";
        }
