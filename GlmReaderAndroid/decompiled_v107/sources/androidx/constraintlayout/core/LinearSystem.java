...
public class LinearSystem {
    ...
    public void displayReadableRows() {
        displaySolverVariables();
        String s = " num vars " + this.mVariablesID + StringUtils.LF;
        for (int i = 0; i < this.mVariablesID + 1; i++) {
            SolverVariable variable = this.mCache.mIndexedVariables[i];
            if (variable != null && variable.isFinalValue) {
                s = s + " $[" + i + "] => " + variable + " = " + variable.computedValue + StringUtils.LF;
            }
        }
        String s2 = s + StringUtils.LF;
        for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
            ...
            if (variable2 != null && variable2.mIsSynonym) {
                ...
                s2 = s2 + " ~[" + i2 + "] => " + variable2 + " = " + synonym + " + " + variable2.mSynonymDelta + StringUtils.LF;
            }
        }
        String s3 = s2 + "\n\n #  ";
        ...
        if (this.mGoal != null) {
            s3 = s3 + "Goal: " + this.mGoal + StringUtils.LF;
        }
    ...
    void displaySystemInformation() {
        ...
        System.out.println("Linear System -> Table size: " + this.mTableSize + " (" + getDisplaySize(this.mTableSize * this.mTableSize) + ") -- row sizes: " + getDisplaySize(rowSize) + ", actual size: " + getDisplaySize(actualRowSize) + " rows: " + this.mNumRows + PackagingURIHelper.FORWARD_SLASH_STRING + this.mMaxRows + " cols: " + this.mNumColumns + PackagingURIHelper.FORWARD_SLASH_STRING + this.mMaxColumns + StringUtils.SPACE + "0 occupied cells, " + getDisplaySize(0));
    }
