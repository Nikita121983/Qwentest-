...
public abstract class Chain extends Helper {
    ...
    public String referencesToString() {
        ...
        StringBuilder builder = new StringBuilder(CollectionUtils.DEFAULT_TOSTRING_PREFIX);
        Iterator<Ref> it = this.references.iterator();
        while (it.hasNext()) {
            Ref ref = it.next();
            builder.append(ref.toString());
        }
        builder.append(CollectionUtils.DEFAULT_TOSTRING_SUFFIX);
    ...
    public class Anchor {
        ...
        public String toString() {
            ...
            if (this.mMargin != 0) {
                ret.append(CollectionUtils.COMMA).append(this.mMargin);
            }
            if (this.mGoneMargin != Integer.MIN_VALUE) {
                if (this.mMargin == 0) {
                    ret.append(",0,").append(this.mGoneMargin);
                } else {
                    ret.append(CollectionUtils.COMMA).append(this.mGoneMargin);
                }
            }
