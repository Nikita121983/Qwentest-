...
public class ConstraintSet {
    ...
    public void setStateLabels(String types) {
        this.mMatchLabels = types.split(CollectionUtils.COMMA);
                ...
                switch (sMapToConstant.get(attr)) {
                    ...
                    case 10:
                        ...
                        if (type.type == 1) {
                            ...
                            if (this.mQuantizeInterpolatorString.indexOf(PackagingURIHelper.FORWARD_SLASH_STRING) > 0) {
                                this.mQuantizeInterpolatorID = a.getResourceId(attr, -1);
                                this.mQuantizeInterpolatorType = -2;
                                break;
                            } else {
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer key : set.mConstraints.keySet()) {
            ...
            if (constraint != null) {
                this.mConstraints.put(key, constraint.m42clone());
            }
        }
    }
    ...
    public void parseIntAttributes(Constraint set, String attributes) {
        String[] sp = attributes.split(CollectionUtils.COMMA);
            ...
            switch (attrType) {
                ...
                case 86:
                    ...
                    if (type.type == 1) {
                        ...
                        if (c.motion.mQuantizeInterpolatorString.indexOf(PackagingURIHelper.FORWARD_SLASH_STRING) > 0) {
                            c.motion.mQuantizeInterpolatorID = a.getResourceId(attr, -1);
                            delta.add(89, c.motion.mQuantizeInterpolatorID);
                            c.motion.mQuantizeInterpolatorType = -2;
                            delta.add(88, c.motion.mQuantizeInterpolatorType);
    ...
    private int[] convertReferenceString(View view, String referenceIdString) {
        String[] split = referenceIdString.split(CollectionUtils.COMMA);
    ...
    class WriteXmlEngine {
        ...
        void writeCircle(int circleConstraint, float circleAngle, int circleRadius) throws IOException {
            ...
            this.mWriter.write(circleRadius + CollectionUtils.DEFAULT_TOSTRING_SUFFIX);
        }
        ...
        void writeVariable(String name, int[] value) throws IOException {
            ...
            while (i < value.length) {
                this.mWriter.write((i == 0 ? CollectionUtils.DEFAULT_TOSTRING_PREFIX : ", ") + getName(value[i]));
                i++;
            }
            this.mWriter.write("],\n");
        }
