...
public class MotionScene {
    ...
    private int mDefaultDuration = FontHeader.REGULAR_WEIGHT;
    ...
    public static class Transition {
        ...
        Transition(MotionScene motionScene, Transition global) {
            ...
            this.mDuration = FontHeader.REGULAR_WEIGHT;
            this.mStagger = 0.0f;
                ...
                if (attr == R.styleable.Transition_constraintSetEnd) {
                    ...
                    if (type3.type == 1) {
                        ...
                        if (this.mDefaultInterpolatorString != null) {
                            if (this.mDefaultInterpolatorString.indexOf(PackagingURIHelper.FORWARD_SLASH_STRING) > 0) {
                                this.mDefaultInterpolatorID = a.getResourceId(attr, -1);
                                this.mDefaultInterpolator = -2;
                            } else {
    ...
    private int getId(Context context, String idString) {
        int id = -1;
        if (idString.contains(PackagingURIHelper.FORWARD_SLASH_STRING)) {
    ...
    private void readConstraintChain(int key, MotionLayout motionLayout) {
        ...
        if (derivedFromId > 0) {
            ...
            if (derivedFrom == null) {
                ...
                cs.derivedState += PackagingURIHelper.FORWARD_SLASH_STRING + derivedFrom.derivedState;
