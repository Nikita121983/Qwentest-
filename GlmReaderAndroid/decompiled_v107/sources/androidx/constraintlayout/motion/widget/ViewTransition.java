...
public class ViewTransition {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (attr == R.styleable.ViewTransition_android_id) {
                ...
                if (type.type == 1) {
                    ...
                    if (this.mDefaultInterpolatorString != null && this.mDefaultInterpolatorString.indexOf(PackagingURIHelper.FORWARD_SLASH_STRING) > 0) {
                        this.mDefaultInterpolatorID = a.getResourceId(attr, -1);
                        this.mDefaultInterpolator = -2;
                    } else {
    ...
    public /* synthetic */ void m40x14d7500(View[] views) {
        if (this.mSetsTag != -1) {
            for (View view : views) {
    ...
    private void updateTransition(MotionScene.Transition transition, View view) {
        ...
        if (this.mKeyFrames != null) {
            ...
            while (it.hasNext()) {
                Key key = it.next();
                keyFrames.addKey(key.mo39clone().setViewId(id));
            }
