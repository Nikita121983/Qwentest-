...
public abstract class SpecialEffectsController {
    ...
    public static class Operation {
        ...
        public String toString() {
            return "Operation " + VectorFormat.DEFAULT_PREFIX + Integer.toHexString(System.identityHashCode(this)) + "} " + VectorFormat.DEFAULT_PREFIX + "mFinalState = " + this.mFinalState + "} " + VectorFormat.DEFAULT_PREFIX + "mLifecycleImpact = " + this.mLifecycleImpact + "} " + VectorFormat.DEFAULT_PREFIX + "mFragment = " + this.mFragment + VectorFormat.DEFAULT_SUFFIX;
        }
