...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public /* synthetic */ void m83lambda$new$0$androidxfragmentappFragmentManager(Configuration newConfig) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m84lambda$new$1$androidxfragmentappFragmentManager(Integer level) {
    ...
    public /* synthetic */ void m85lambda$new$2$androidxfragmentappFragmentManager(MultiWindowModeChangedInfo info) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m86lambda$new$3$androidxfragmentappFragmentManager(PictureInPictureModeChangedInfo info) {
        if (isParentAdded()) {
        ...
        for (int i2 = index; i2 < this.mBackStack.size(); i2++) {
            ...
            if (!affectedFragments.isEmpty()) {
                ...
                if (affectedFragments.size() == 1) {
                    str2 = StringUtils.SPACE + affectedFragments.iterator().next();
                } else {
    ...
    public Parcelable saveAllState() {
        ...
        Bundle savedState = m82lambda$attachController$4$androidxfragmentappFragmentManager();
