...
public final class MutableIntObjectMap<V> extends IntObjectMap<V> {
    ...
    */
    ...
    private final void adjustStorage() {
        if (this._capacity > 8 && Long.compareUnsigned(ULong.m570constructorimpl(ULong.m570constructorimpl(this._size) * 32), ULong.m570constructorimpl(ULong.m570constructorimpl(this._capacity) * 25)) <= 0) {
