    ...
    */
    ...
    public static final class UpdateOp {
        ...
        public String toString() {
            return Integer.toHexString(System.identityHashCode(this)) + CollectionUtils.DEFAULT_TOSTRING_PREFIX + cmdToString() + ",s:" + this.positionStart + "c:" + this.itemCount + ",p:" + this.payload + CollectionUtils.DEFAULT_TOSTRING_SUFFIX;
        }
