...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    int findPositionOfLastItemOnARowAboveForHorizontalGrid(int startingRow) {
        ...
        Map<Integer, Integer> rowToLastItemPositionMap = new TreeMap<>((Comparator<? super Integer>) Collections.reverseOrder());
        ...
        Iterator<Integer> it2 = rowToLastItemPositionMap.keySet().iterator();
        while (it2.hasNext()) {
            int row2 = it2.next().intValue();
            if (row2 < startingRow) {
    ...
    int findPositionOfFirstItemOnARowBelowForHorizontalGrid(int startingRow) {
        ...
        Iterator<Integer> it2 = rowToFirstItemPositionMap.keySet().iterator();
        while (it2.hasNext()) {
            int row2 = it2.next().intValue();
            if (row2 > startingRow) {
    ...
    public void onLayoutCompleted(RecyclerView.State state) {
        ...
        if (this.mPositionTargetedByScrollInDirection != -1 && (viewTargetedByScrollInDirection = findViewByPosition(this.mPositionTargetedByScrollInDirection)) != null) {
            viewTargetedByScrollInDirection.sendAccessibilityEvent(AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL);
            this.mPositionTargetedByScrollInDirection = -1;
        }
    }
