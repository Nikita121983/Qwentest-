...
public final class AndroidSQLiteDriverPooledConnection implements Transactor, RawConnectionAccessor {
    ...
    public <R> Object usePrepared(String sql, Function1<? super SQLiteStatement, ? extends R> function1, Continuation<? super R> continuation) {
        SQLiteStatement prepare = this.delegate.prepare(sql);
        try {
    ...
    */
    public final <R> java.lang.Object transaction(androidx.room.Transactor.SQLiteTransactionType r8, kotlin.jvm.functions.Function2<? super androidx.room.TransactionScope<R>, ? super kotlin.coroutines.Continuation<? super R>, ? extends java.lang.Object> r9, kotlin.coroutines.Continuation<? super R> r10) {
        /*
            r7 = this;
            boolean r0 = r10 instanceof androidx.room.coroutines.AndroidSQLiteDriverPooledConnection$transaction$1
            if (r0 == 0) goto L14
            r0 = r10
        ...
        L2d:
            ...
            androidx.room.coroutines.AndroidSQLiteDriverPooledConnection r9 = (androidx.room.coroutines.AndroidSQLiteDriverPooledConnection) r9
        ...
        L41:
            ...
            r3 = r7
            androidx.sqlite.driver.AndroidSQLiteConnection r5 = r3.delegate
            android.database.sqlite.SQLiteDatabase r5 = r5.getDb()
            boolean r6 = r5.inTransaction()
            if (r6 != 0) goto L53
            r3.currentTransactionType = r8
        L53:
            int[] r6 = androidx.room.coroutines.AndroidSQLiteDriverPooledConnection.WhenMappings.$EnumSwitchMapping$0
            int r8 = r8.ordinal()
            r8 = r6[r8]
            switch(r8) {
                case 1: goto L6d;
        ...
        L6d:
            r5.beginTransactionNonExclusive()
        L70:
            androidx.room.coroutines.AndroidSQLiteDriverPooledConnection$AndroidSQLiteDriverTransactor r8 = new androidx.room.coroutines.AndroidSQLiteDriverPooledConnection$AndroidSQLiteDriverTransactor     // Catch: java.lang.Throwable -> L9c androidx.room.coroutines.ConnectionPool.RollbackException -> La0
