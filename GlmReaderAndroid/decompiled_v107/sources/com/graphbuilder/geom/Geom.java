...
public final class Geom {
    ...
    public static double getAngle(double originX, double originY, double x, double y) {
        ...
        return x >= originX ? y < originY ? 6.283185307179586d - rad : rad : y < originY ? rad + 3.141592653589793d : 3.141592653589793d - rad;
    }
    ...
    public static double getTriangleAreaSq(double a, double b, double c) {
        ...
        double t3 = b + c;
        return ((((t3 + a) * (c - (a - b))) * ((a - b) + c)) * ((b - c) + a)) / 16.0d;
    }
}
