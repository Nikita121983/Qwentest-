...
public class SignatureInfoV1DocumentImpl extends XmlComplexContentImpl implements SignatureInfoV1Document {
    ...
    public CTSignatureInfoV1 getSignatureInfoV1() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            CTSignatureInfoV1 target = (CTSignatureInfoV1) get_store().find_element_user(PROPERTY_QNAME[0], 0);
            cTSignatureInfoV1 = target == null ? null : target;
        }
    ...
    public void setSignatureInfoV1(CTSignatureInfoV1 signatureInfoV1) {
        generatedSetterHelperImpl(signatureInfoV1, PROPERTY_QNAME[0], 0, (short) 1);
    }

    @Override // com.microsoft.schemas.office.x2006.digsig.SignatureInfoV1Document
    public CTSignatureInfoV1 addNewSignatureInfoV1() {
        CTSignatureInfoV1 target;
        synchronized (monitor()) {
            check_orphaned();
            target = (CTSignatureInfoV1) get_store().add_element_user(PROPERTY_QNAME[0]);
        }
        return target;
    }
}
