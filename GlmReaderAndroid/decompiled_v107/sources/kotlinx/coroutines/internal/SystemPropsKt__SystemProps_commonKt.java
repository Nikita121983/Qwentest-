...
public final /* synthetic */ class SystemPropsKt__SystemProps_commonKt {
    ...
    public static final long systemProp(String propertyName, long defaultValue, long minValue, long maxValue) {
        ...
        if (longOrNull == null) {
            throw new IllegalStateException(("System property '" + propertyName + "' has unrecognized value '" + value + Chars.QUOTE).toString());
        }
        ...
        if (!z) {
            throw new IllegalStateException(("System property '" + propertyName + "' should be in range " + minValue + ".." + maxValue + ", but is '" + parsed + Chars.QUOTE).toString());
        }
        return parsed;
    }
