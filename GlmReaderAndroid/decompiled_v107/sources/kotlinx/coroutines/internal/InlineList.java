...
public final class InlineList<E> {
    ...
    public static final /* synthetic */ InlineList m1955boximpl(Object obj) {
        return new InlineList(obj);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <E> Object m1956constructorimpl(Object obj) {
        return obj;
    }
    ...
    public boolean equals(Object other) {
        return m1958equalsimpl(this.holder, other);
    }

    public int hashCode() {
        return m1961hashCodeimpl(this.holder);
    }

    public String toString() {
        return m1963toStringimpl(this.holder);
    }
    ...
    public static /* synthetic */ Object m1957constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m1956constructorimpl(obj);
    }

    /* renamed from: plus-FjFbRPM, reason: not valid java name */
    public static final Object m1962plusFjFbRPM(Object arg0, E e) {
        if (DebugKt.getASSERTIONS_ENABLED() && (e instanceof List)) {
            throw new AssertionError();
        }
        if (arg0 == null) {
            return m1956constructorimpl(e);
        }
        if (arg0 instanceof ArrayList) {
            ...
            return m1956constructorimpl(arg0);
        }
        ArrayList list = new ArrayList(4);
        list.add(arg0);
        list.add(e);
        return m1956constructorimpl(list);
    }

    /* renamed from: forEachReversed-impl, reason: not valid java name */
    public static final void m1960forEachReversedimpl(Object obj, Function1<? super E, Unit> function1) {
        if (obj == null) {
            return;
        }
