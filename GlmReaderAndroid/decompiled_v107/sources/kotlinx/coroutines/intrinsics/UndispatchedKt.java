        ...
        try {
            ...
            try {
                ...
                if (value != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    actualCompletion.resumeWith(Result.m396constructorimpl(value));
                }
            } finally {
            ...
            actualCompletion.resumeWith(Result.m396constructorimpl(ResultKt.createFailure(reportException)));
        }
    }
