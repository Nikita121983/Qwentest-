...
public final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m1941debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt.debounce(flow, DelayKt.m1887toDelayMillisLRDsOJo(timeout));
    }
    ...
    public static final long debounce$lambda$2$FlowKt__DelayKt(Function1 $timeout, Object emittedItem) {
        return DelayKt.m1887toDelayMillisLRDsOJo(((Duration) $timeout.invoke(emittedItem)).getRawValue());
    }
    ...
    public static final <T> Flow<T> m1942sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt.sample(flow, DelayKt.m1887toDelayMillisLRDsOJo(period));
    }

    /* renamed from: timeout-HG0u8IE, reason: not valid java name */
    public static final <T> Flow<T> m1943timeoutHG0u8IE(Flow<? extends T> flow, long timeout) {
        return m1944timeoutInternalHG0u8IE$FlowKt__DelayKt(flow, timeout);
    }

    /* renamed from: timeoutInternal-HG0u8IE$FlowKt__DelayKt, reason: not valid java name */
    private static final <T> Flow<T> m1944timeoutInternalHG0u8IE$FlowKt__DelayKt(Flow<? extends T> flow, long timeout) {
