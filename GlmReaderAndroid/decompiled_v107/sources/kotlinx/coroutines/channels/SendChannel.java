...
public interface SendChannel<E> {
    ...
    Object mo1899trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo1899trySendJP2dKIU(e);
            if (ChannelResult.m1924isSuccessimpl(result)) {
                return true;
            }
            Throwable m1918exceptionOrNullimpl = ChannelResult.m1918exceptionOrNullimpl(result);
