...
public final class ChannelsKt__ChannelsKt$trySendBlocking$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        try {
            ...
            r = Result.m396constructorimpl(Unit.INSTANCE);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            r = Result.m396constructorimpl(ResultKt.createFailure(th));
        }
        return ChannelResult.m1914boximpl(Result.m403isSuccessimpl(r) ? ChannelResult.INSTANCE.m1929successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1927closedJP2dKIU(Result.m399exceptionOrNullimpl(r)));
    }
}
