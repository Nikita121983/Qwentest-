...
public interface ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo1907tryReceivePtdJZtk = receiveChannel.mo1907tryReceivePtdJZtk();
            if (ChannelResult.m1924isSuccessimpl(mo1907tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1920getOrThrowimpl(mo1907tryReceivePtdJZtk);
            }
            Throwable m1918exceptionOrNullimpl = ChannelResult.m1918exceptionOrNullimpl(mo1907tryReceivePtdJZtk);
            if (m1918exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1918exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L37:
                ...
                return r2
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m1919getOrNullimpl(r4)
                return r4
            */
