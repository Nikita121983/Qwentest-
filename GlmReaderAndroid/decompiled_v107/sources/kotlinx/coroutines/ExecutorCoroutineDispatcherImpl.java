...
public final class ExecutorCoroutineDispatcherImpl extends ExecutorCoroutineDispatcher implements Delay {
    ...
    public void mo1966dispatch(CoroutineContext context, Runnable block) {
        Runnable runnable;
        try {
            ...
            Dispatchers.getIO().mo1966dispatch(context, block);
        }
    }

    @Override // kotlinx.coroutines.Delay
    /* renamed from: scheduleResumeAfterDelay */
    public void mo1967scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        long timeMillis2;
        Executor executor = getExecutor();
        ...
        if (future != null) {
            ...
            DefaultExecutor.INSTANCE.mo1967scheduleResumeAfterDelay(timeMillis2, continuation);
        }
    }
