...
final class ConcurrentHashMapParametrizedCache<T> implements ParametrizedSerializerCache<T> {
    ...
    public Object mo1987getgIAlus(KClass<Object> key, List<? extends KType> types) {
        ...
        if (obj == null) {
            try {
                ...
                m396constructorimpl = Result.m396constructorimpl(this.compute.invoke(key, types));
            } catch (Throwable th) {
            ...
            Object putIfAbsent2 = $this$getOrPut$iv$iv.putIfAbsent(arrayList, m395boximpl);
            obj = putIfAbsent2 == null ? m395boximpl : putIfAbsent2;
        }
