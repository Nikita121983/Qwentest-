...
final class ParametrizedCacheEntry<T> {
    ...
    public final Object m1992computeIfAbsentgIAlus(List<? extends KType> types, Function0<? extends KSerializer<T>> producer) {
        ...
        if (obj == null) {
            try {
                ...
                m396constructorimpl = Result.m396constructorimpl(producer.invoke());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                m396constructorimpl = Result.m396constructorimpl(ResultKt.createFailure(th));
            }
            Result m395boximpl = Result.m395boximpl(m396constructorimpl);
            Object putIfAbsent = $this$getOrPut$iv.putIfAbsent(arrayList, m395boximpl);
            obj = putIfAbsent == null ? m395boximpl : putIfAbsent;
        }
