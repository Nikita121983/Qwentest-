...
public final class SealedClassSerializer<T> extends AbstractPolymorphicSerializer<T> {
    ...
    public SealedClassSerializer(final String serialName, KClass<T> baseClass, KClass<? extends T>[] subclasses, KSerializer<? extends T>[] subclassSerializers) {
        ...
        while (sourceIterator.hasNext()) {
            ...
            String key = keyOf;
            if (accumulator != null) {
                throw new IllegalStateException(("Multiple sealed subclasses of '" + getBaseClass() + "' have the same serial name '" + key + "': '" + accumulator.getKey() + "', '" + element.getKey() + Chars.QUOTE).toString());
            }
