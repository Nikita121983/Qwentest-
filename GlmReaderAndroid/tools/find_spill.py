...
SPILL_KEYWORDS = [
    'FILTER', 'UNIQUE', 'SORT', 'SORTBY', 'LET', 'LAMBDA', 'MAP', 'REDUCE',
    'SCAN', 'MAKEARRAY', 'XLOOKUP', 'TOCOL', 'TOROW', 'WRAPCOLS', 'WRAPROWS',
    'VSTACK', 'HSTACK', 'CHOOSEROWS', 'TAKE', 'DROP',
    'ФИЛЬТР', 'УНИК', 'СОРТ', 'СОРТПО', 'ДВССЫЛ', 'СЖПРОБЕЛЫ',
    'ДАННЫМИТАБЛ', 'SEQUENCE', 'EXPAND', 'ISOMITTED',
]
